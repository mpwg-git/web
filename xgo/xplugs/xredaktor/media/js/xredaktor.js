...
xredaktor_.prototype = {
	...
	openLess: function()
	{
		this.setLastCommand('xredaktor','openLess');
		xframe.setAppTitle('Less');
		this.switchContent(xredaktor_css_less.getInstance().getMainPanel(this.getCurrentSiteId()));
	},
	...
	****************************************************************************************************/
	...
	openRoles: function()
	{
		this.setLastCommand('xredaktor','openRoles');
	...
	openKalt: function()
	{
		xframe.setAppTitle('KaltTool');
		this.switchContent(xkalt.getInstance().getMainPanel());
	},
	...
	open_ROLES_TAGS : function()
	{
		this.setLastCommand('xredaktor','open_ROLES_TAGS');
		xframe.setAppTitle('Roles Tags');
		this.switchContent(xredaktor_roles_tags.getInstance().getMainPanel());
	},
	...
	****************************************************************************************************/
	...
	getTopToolbar : function() {
		...
		var me = this;
		var xkalt = this.makePluginFunctionButton('xredaktor',{
			classx: "xredaktor",
			text: 'Kalt',
			glyph: '',
			iconCls:  'icon-export',
		...
		topBar.push('-',this.getSettingsButton(),this.getProjectSwitcherButton(),'->',xkalt,this.getNewWindowButton(),this.getAboutButton(),this.getUserTools()/*,this.getLogOffButton()*/);
		return topBar;
	},
