...
Ext.define('Ext.xr.field_wizardlist', {
	...
	initComponent: function () {
		...
		console.info('backEndInfos',this.backEndInfos);
		...
		this.columns.unshift(Ext.create('Ext.grid.RowNumberer',{}));
		...
		this.paramsBack.published = 0;
		this.paramsBack.initSort = '[{"property":"wz_id","direction":"ASC"}]';
	...
	statics: {
		openConfigWindow: function(as,grid) {
			...
			Ext.xr.field.openDefaultConfigWindow({
				grid: grid,
				as: as,
				title: 'Wizard Datensatzliste - Fremdfeld',
				fields: [{
