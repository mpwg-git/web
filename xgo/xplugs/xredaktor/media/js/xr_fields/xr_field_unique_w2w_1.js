Ext.define('Ext.xr.field_unique_w2w_1', {
	extend: 'Ext.form.field.ComboBox',
	alias: 'widget.xr_field_unique_w2w_1',
	...
	constructor:function(cnfg){
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				...
				type: 'ajax',
				url: '/xgo/xplugs/xredaktor/ajax/gui/searchInField?published=1&useAsId=1&as_id='+searchId,
				reader: {
					root: 'root',
