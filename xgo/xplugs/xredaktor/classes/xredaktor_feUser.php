...
class xredaktor_feUser
{
	...
	*/
	...
	private static $mailPage_changeMailWithToken_subject	= "Neue E-Mailadresse auf MeinePerfekteWG bestätigen";
	...
	******************************************************************************************/
	...
	private static function sendTokenMail2($wz_id,$subject=false,$params=false)
	{
		...
		$customerMail	= trim($u[self::$userField_eMailOld]); //neue mail in wz_mail_alt tempor�r gesaved bis mail_checked == y
