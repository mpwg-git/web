...
xkalt_.prototype = {
    ...
    createPanel_details: function() {
		...
		{name: 'wz_phone',			text:'TelNR',				type:'string' , hidden: false,	header: true},
		{name: 'wz_status',			text:'Status',				type:'string' , hidden: false,	header: true},
		];
        ...
        var stateStore = Ext.create('Ext.data.Store', {
            ...
            fields: ['abbr', 'status'],
            data: [
               	{'abbr':'ZW', 'status':'Zimmer weg'},
	            {'abbr':'WN', 'status':'Will nicht'},
	            {'abbr':'T0', 'status':'TelNr = 0'},
	            {'abbr':'MV', 'status':'Mail verschickt'},
	            {'abbr':'AK', 'status':'Aktiviert'},
	            {'abbr':'NE', 'status':'Nicht erreicht'},
	            {'abbr':'JA', 'status':'Ja'},
	            {'abbr':'AN', 'status':'Anderes'},
	            {'abbr':'NEU', 'status':'NEU'},
            ]
        });
