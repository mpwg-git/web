<?php /* Smarty version Smarty-3.0.7, created on 2017-02-09 11:04:53
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codehBgypJ" */ ?>
<?php /*%%SmartyHeaderCode:924282010589c3ec5346292-88038555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c45ae8b98ce7af5733db5e8ebb252fbe0ce29a5' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codehBgypJ',
      1 => 1486634693,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '924282010589c3ec5346292-88038555',
  'function' => 
  array (
  ),
...
<header id="main-header">
    <div class="container-fluid">
        <div class="header-logo">
            <svg id="icon-duck" data-name="icon-duck" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 70" style="width: 3.5rem; margin: 2.1rem 0 0 19.3rem;">
                <defs>
            ...
            <img src="/xstorage/template/img/redesign/mpwg-schriftzug.png" alt="Logo" class="img-logo"/>
        </div>
        <div id="main-nav" class="header-nav">
            <button type="button" class="btn btn-default btn-login">Login</button>
            <span>
                <a href="/de/start" class="navlinks active">DE&nbsp;</a><span class="navlinks">|</span>
                <a href="/en/start" class="navlinks">EN</a>
            </span>
        </div>
    </div>
</header>