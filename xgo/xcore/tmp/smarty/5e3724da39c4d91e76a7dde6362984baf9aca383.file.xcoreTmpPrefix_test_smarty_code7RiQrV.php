<?php /* Smarty version Smarty-3.0.7, created on 2016-08-03 15:38:00
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7RiQrV" */ ?>
<?php /*%%SmartyHeaderCode:117450494657a1f3b8c68198-43739234%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e3724da39c4d91e76a7dde6362984baf9aca383' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7RiQrV',
      1 => 1470231480,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '117450494657a1f3b8c68198-43739234',
  'function' => 
  array (
  ),
...
" class="navlinks active">&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Abmelden</a>
    ...
    <?php if ($_smarty_tpl->getVariable('P_ID')->value==11){?>
      <?php echo smarty_function_xr_siteCall(array('fn'=>'fe_matching::sc_checkIfUserHasAnyQuestionAnswered','var'=>'hasQuestionsAnswered'),$_smarty_tpl);?>
         ...
         <?php if ($_REQUEST['dev']==1||$_smarty_tpl->getVariable('stillToDo')->value===true){?>
            <div id="overlayNoQuestionAnswered" class="modal fade" role="dialog" data-toggle="modal" data-show="true">
