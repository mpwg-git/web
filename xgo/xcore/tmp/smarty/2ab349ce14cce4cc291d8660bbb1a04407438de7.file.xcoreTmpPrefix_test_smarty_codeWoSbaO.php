<?php /* Smarty version Smarty-3.0.7, created on 2016-01-12 11:11:36
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeWoSbaO" */ ?>
<?php /*%%SmartyHeaderCode:11751383395694d15829e685-09325409%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ab349ce14cce4cc291d8660bbb1a04407438de7' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeWoSbaO',
      1 => 1452593496,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11751383395694d15829e685-09325409',
  'function' => 
  array (
  ),
 ...
 <?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('data')->value['USER']['wz_created'],"%d.%m.%Y");?>
            ...
            -->
             ...
             <li>
                ...
                <div class="meinprofil-meinkonto-collapse collapse" id="collapseProfileKonto">
            		<div class="submitbutton-container">
                        <button id="form-del-account" style="width:80%" class="button button-default button-small"><?php echo smarty_function_xr_translate(array('tag'=>"Account löschen"),$_smarty_tpl);?>
</button>
                    </div>
                    <br/>
                    <div class="submitbutton-container">
                         <button id="<?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_ACTIVE']=='Y'){?>form-deactivate-account<?php }else{ ?>form-reactivate-account<?php }?>" style="width:80%" class="button button-default button-small">
