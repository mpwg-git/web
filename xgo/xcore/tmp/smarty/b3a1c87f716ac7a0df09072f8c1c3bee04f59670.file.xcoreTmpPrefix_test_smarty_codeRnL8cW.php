<?php /* Smarty version Smarty-3.0.7, created on 2015-07-21 18:39:54
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeRnL8cW" */ ?>
<?php /*%%SmartyHeaderCode:77114739555ae75daa58865-89110827%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3a1c87f716ac7a0df09072f8c1c3bee04f59670' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeRnL8cW',
      1 => 1437496794,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '77114739555ae75daa58865-89110827',
  'function' => 
  array (
  ),
    ...
    <form class="form-mein-profil">
        ...
        <div class="form-group">
            ...
            <label for="raucherja" class="radio">
                ...
                <span class="checked circle-plain">ja</span>
                <span class="unchecked circle-filled">jaC</span>
            </label>
            <label for="rauchernein" class="radio">
                <input id="rauchernein" type="radio" name="raucher" />
                <span class="checked circle-plain">nein</span>
                <span class="unchecked circle-filled">neinC</span>
            </label>
        </div>
