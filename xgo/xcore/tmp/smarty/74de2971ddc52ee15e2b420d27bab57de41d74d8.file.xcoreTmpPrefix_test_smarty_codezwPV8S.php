<?php /* Smarty version Smarty-3.0.7, created on 2016-01-13 10:06:01
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codezwPV8S" */ ?>
<?php /*%%SmartyHeaderCode:103185684956961379768c20-07952833%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '74de2971ddc52ee15e2b420d27bab57de41d74d8' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codezwPV8S',
      1 => 1452675961,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '103185684956961379768c20-07952833',
  'function' => 
  array (
  ),
...
<div class="meinprofil-profilbild add-image add-image-profil profileimage" data-type="profile">
    ...
    <?php if (($_smarty_tpl->getVariable('data')->value['USER']>0)){?>
        <?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_TYPE']=='biete'&&$_smarty_tpl->getVariable('P_ID')->value==30){?>
            <?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->getVariable('d')->value,'w'=>180,'h'=>197,'rmode'=>"cco",'class'=>"profileimage-img"),$_smarty_tpl);?>
