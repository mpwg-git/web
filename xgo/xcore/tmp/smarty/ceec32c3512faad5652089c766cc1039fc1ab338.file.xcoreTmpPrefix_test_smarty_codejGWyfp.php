<?php /* Smarty version Smarty-3.0.7, created on 2017-02-10 12:18:27
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejGWyfp" */ ?>
<?php /*%%SmartyHeaderCode:1339881133589da1836d0ae7-85492400%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ceec32c3512faad5652089c766cc1039fc1ab338' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejGWyfp',
      1 => 1486725507,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1339881133589da1836d0ae7-85492400',
  'function' => 
  array (
  ),
...
$("#btn-wg").mouseover(function(e){
    $("img.svg.btn-icon-wg").attr('src', '/xstorage/template/redesign/svg/icon-wg-sucht-wg-black.svg');
...
$("#btn-wg").mouseout(function(e){
    $("img.svg.btn-icon-wg").attr('src', '/xstorage/template/redesign/svg/icon-wg-sucht-wg-turkis.svg');
