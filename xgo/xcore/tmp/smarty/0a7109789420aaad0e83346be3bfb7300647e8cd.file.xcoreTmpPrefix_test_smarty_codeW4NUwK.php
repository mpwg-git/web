<?php /* Smarty version Smarty-3.0.7, created on 2015-11-25 09:39:35
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeW4NUwK" */ ?>
<?php /*%%SmartyHeaderCode:2101212818565573c7a4af19-91861485%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a7109789420aaad0e83346be3bfb7300647e8cd' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeW4NUwK',
      1 => 1448440775,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2101212818565573c7a4af19-91861485',
  'function' => 
  array (
  ),
...
" method="post" id="form-register">
                ...
                <div class="form-group">
                    <label for="suche" class="radio special-label">
                        <input id="suche" type="radio" name="TYPE" rel="required_radio_oneofmany" />
                    ...
                    <span class="label-oder"><?php echo smarty_function_xr_translate(array('tag'=>'ODER'),$_smarty_tpl);?>
</span>
                    <label for="biete" class="radio special-label">
                        <input id="biete" type="radio" name="TYPE" rel="required_radio_oneofmany" />
