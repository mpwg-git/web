<?php /* Smarty version Smarty-3.0.7, created on 2016-08-03 16:39:18
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeI6iuJu" */ ?>
<?php /*%%SmartyHeaderCode:171057675757a20216ce6d42-14972436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d0307a3c5dd5ea144b27f14ee3e17cb37375e81' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeI6iuJu',
      1 => 1470235158,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '171057675757a20216ce6d42-14972436',
  'function' => 
  array (
  ),
...
" class="navlinks active">&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Abmelden</a>
    ...
    <?php if ($_smarty_tpl->getVariable('P_ID')->value==11){?>
        ...
        <?php }elseif($_REQUEST['dev']==2||$_smarty_tpl->getVariable('hasQuestionsAnswered')->value===false){?>
            <div style="margin: 40px 0 0 0;width: 100%;background: #04e0d7;color: black;padding: 1vw 30vw 1.5vw 30vw;text-align: center;font-family: 'jaapokkiregular';font-weight: bold;text-transform: uppercase;">
                <br>
                <p>
                   <?php echo smarty_function_xr_translate(array('tag'=>'Du hast noch keine Fragen vom WG-Test beantwortet!'),$_smarty_tpl);?>

                   <br>
                   <?php echo smarty_function_xr_translate(array('tag'=>'Dr. Duck kann dir deswegen nicht sagen,<br>wer am besten zu dir passt!'),$_smarty_tpl);?>
