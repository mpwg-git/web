<?php /* Smarty version Smarty-3.0.7, created on 2016-08-12 20:56:34
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_coderfm0Mh" */ ?>
<?php /*%%SmartyHeaderCode:127597654357ae1be2e3bf41-35836016%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4aaa7eae1f4608f91bd7faa894ab33ce4aa0b55b' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_coderfm0Mh',
      1 => 1471028194,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '127597654357ae1be2e3bf41-35836016',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                <label style="margin-right: 20px;">Benachrichtigung</label>
                <label for="emailja" class="radio special-label">
                    <input id="emailja" type="radio" name="EMAILNOTIFICATION" value="<?php echo $_smarty_tpl->getVariable('user')->value['wz_EMAILNOTIFICATION'];?>
" checked="checked">
                ...
                <label for="emailnein" class="radio special-label">
                    <input id="emailnein" type="radio" name="EMAILNOTIFICATION" value="<?php echo $_smarty_tpl->getVariable('user')->value['wz_EMAILNOTIFICATION'];?>
" checked="checked">
