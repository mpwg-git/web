<?php /* Smarty version Smarty-3.0.7, created on 2015-10-09 11:19:07
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeE1IMbV" */ ?>
<?php /*%%SmartyHeaderCode:11871065665617868b6ee054-71974877%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46c7f3bac58595fe7016bed0ad0b88d7724b89a5' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeE1IMbV',
      1 => 1444382347,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11871065665617868b6ee054-71974877',
  'function' => 
  array (
  ),
...
<?php }?></label>
    ...
    <label for="mitbew-male" class="radio special-label">
     ...
     <label for="mitbew-male" class="radio special-label">
        <input id="mitbew-male" type="radio" name="MITBEWOHNER" value="M" <?php if ($_smarty_tpl->getVariable('profile')->value['wz_MITBEWOHNER']=='M'){?>checked="checked"<?php }?> "/>
        <span class="checked icon-mann"><?php echo smarty_function_xr_translate(array('tag'=>'egal'),$_smarty_tpl);?>
</span>
        <span class="unchecked icon-mann_outline"><?php echo smarty_function_xr_translate(array('tag'=>'egal'),$_smarty_tpl);?>
</span>
    </label>
