<?php /* Smarty version Smarty-3.0.7, created on 2016-01-14 12:56:12
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codepMSYam" */ ?>
<?php /*%%SmartyHeaderCode:180559851756978cdc11a599-43120511%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0be434839371803cd07d7571ec5f454836f054d6' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codepMSYam',
      1 => 1452772572,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180559851756978cdc11a599-43120511',
  'function' => 
  array (
  ),
...
!</a>
                    ...
                    <?php }else{ ?>
                        ...
                        <?php $_smarty_tpl->tpl_vars['wgtestnumber'] = new Smarty_variable(1, null, null);?>
                        <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('wgtestdata')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
                            <?php $_smarty_tpl->tpl_vars['wgtestnumber'] = new Smarty_variable($_smarty_tpl->getVariable('wgtestnumber')->value+1, null, null);?>
                        <?php }} ?>
                        
                        <?php echo $_smarty_tpl->getVariable('wgtestnumber')->value;?>

                        
                        <?php echo smarty_function_xr_translate(array('tag'=>"Du hast bereits"),$_smarty_tpl);?>
 5 <?php echo smarty_function_xr_translate(array('tag'=>"von"),$_smarty_tpl);?>
 15 <?php echo smarty_function_xr_translate(array('tag'=>"Fragen beantwortet"),$_smarty_tpl);?>
.
                    
                        <p>Meinung geändert?</p>
                        
                        Fortsetzen bei nächster unbeantworteten Frage
                        
                        Alle Fragen noch einmal durchgehen
...
"><?php echo smarty_function_xr_translate(array('tag'=>"Fortsetzen"),$_smarty_tpl);?>
                        ...
                        <?php echo smarty_function_xr_print_r(array('val'=>$_smarty_tpl->getVariable('wgtestdata')->value),$_smarty_tpl);?>
