<?php /* Smarty version Smarty-3.0.7, created on 2016-08-16 10:37:53
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeCNEfHO" */ ?>
<?php /*%%SmartyHeaderCode:125416994857b2d0e16d3b42-15127353%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1aecabcd8a6234434e03de1388cf53500826389e' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeCNEfHO',
      1 => 1471336673,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '125416994857b2d0e16d3b42-15127353',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                ...
                <label for="emailja" class="radio special-label">
                    ...
                    <span class="checked circle circle-filled" style="background: #333; color: white; border: 1px solid white;">ja</span>
                    <span class="unchecked circle circle-plain" style="color: #333; border: 1px solid white;">ja</span>
                </label>
                <label for="emailnein" class="radio special-label">
                    ...
                    <span class="checked circle circle-filled" style="background: #333; color: white; border: 1px solid white;">nein</span>
                    <span class="unchecked circle circle-plain" style="color: #333; border: 1px solid white;">nein</span>
                </label>
            </div>                
            <div class="form-group">
