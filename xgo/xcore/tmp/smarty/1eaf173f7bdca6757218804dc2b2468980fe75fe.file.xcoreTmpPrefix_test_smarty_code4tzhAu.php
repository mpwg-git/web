<?php /* Smarty version Smarty-3.0.7, created on 2015-11-23 14:29:52
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4tzhAu" */ ?>
<?php /*%%SmartyHeaderCode:182615333565314d06b3554-91473750%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1eaf173f7bdca6757218804dc2b2468980fe75fe' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4tzhAu',
      1 => 1448285392,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '182615333565314d06b3554-91473750',
  'function' => 
  array (
  ),
...
" style="font-size:8.046vw"><?php echo smarty_function_xr_translate(array('tag'=>"Suche"),$_smarty_tpl);?>
    ...
    <form>
        <div class="form-group">
            ...
            <div class="radio">
                <label for="typ-suche" class="no-padding-left radio<?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="biete"||($_smarty_tpl->getVariable('searchSession')->value['type']==''&&$_smarty_tpl->getVariable('userType')->value=="biete")){?> active<?php }?>">
                ...
                <label for="typ-biete" class="radio <?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="suche"||($_smarty_tpl->getVariable('searchSession')->value['type']==''&&$_smarty_tpl->getVariable('userType')->value=="suche")){?> active<?php }?>">
