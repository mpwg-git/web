<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 17:52:14
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeojyqep" */ ?>
<?php /*%%SmartyHeaderCode:95667812556782e3e260944-39062451%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7580b984966192bbbbd273c663cedd376552bf2' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeojyqep',
      1 => 1450716734,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '95667812556782e3e260944-39062451',
  'function' => 
  array (
  ),
...
:</span>
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON']!=''){?> 
                <span class="info"><?php echo smarty_function_xr_translate(array('tag'=>'von'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON'];?>
            ...
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_BIS']!=''){?>
                <span class="info"><?php echo smarty_function_xr_translate(array('tag'=>'bis'),$_smarty_tpl);?>
