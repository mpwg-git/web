<?php /* Smarty version Smarty-3.0.7, created on 2016-09-20 09:55:59
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeDYuaFt" */ ?>
<?php /*%%SmartyHeaderCode:132103729857e0eb8fda6ab5-68802580%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7056ae1667a2add1b32e0ebec8a2ac7e1550e00' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeDYuaFt',
      1 => 1474358159,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '132103729857e0eb8fda6ab5-68802580',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                ...
                <select id="emailbenachrichtigung" name="EMAILBENACHRICHTIGUNG" class="form-control select-helvetica">
                    <option value="DE" <?php if (($_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']=='DE')){?>selected="selected"<?php }?>></option>
                    <option value="EN" <?php if (($_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']=='EN')){?>selected="selected"<?php }?>></option>
                    <option value="KEINE" <?php if (($_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']=='KEINE')){?>selected="selected"<?php }?>></option>
                </select>
            </div>
