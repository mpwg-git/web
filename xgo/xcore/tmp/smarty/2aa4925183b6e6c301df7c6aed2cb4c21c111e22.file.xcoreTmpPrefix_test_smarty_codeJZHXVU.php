<?php /* Smarty version Smarty-3.0.7, created on 2015-11-13 16:42:06
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeJZHXVU" */ ?>
<?php /*%%SmartyHeaderCode:2013884469564604ce09be27-62716821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2aa4925183b6e6c301df7c6aed2cb4c21c111e22' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeJZHXVU',
      1 => 1447429326,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2013884469564604ce09be27-62716821',
  'function' => 
  array (
  ),
...
:</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['ZEITRAUM'];?>
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['MIETE']!=''){?>
    <div class="fakt clearfix">
        <span class="aufzaehlung"><?php echo smarty_function_xr_translate(array('tag'=>"Miete"),$_smarty_tpl);?>
</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['MIETE'];?>
 €</span>
    </div>
    <?php }?>
    
    <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['ZIMMERGROESSE']!=''){?>
    <div class="fakt clearfix">
        <span class="aufzaehlung"><?php echo smarty_function_xr_translate(array('tag'=>"Zimmergrösse"),$_smarty_tpl);?>
</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['ZIMMERGROESSE'];?>
 m²</span>
    </div>
    <?php }?>
