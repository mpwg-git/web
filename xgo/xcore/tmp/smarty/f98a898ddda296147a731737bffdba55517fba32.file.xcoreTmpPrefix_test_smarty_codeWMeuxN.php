<?php /* Smarty version Smarty-3.0.7, created on 2015-11-25 10:39:59
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeWMeuxN" */ ?>
<?php /*%%SmartyHeaderCode:1951073155565581ef83e3c5-43937341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f98a898ddda296147a731737bffdba55517fba32' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeWMeuxN',
      1 => 1448444399,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1951073155565581ef83e3c5-43937341',
  'function' => 
  array (
  ),
...
">
 ...
 <?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['roomloop']['iteration'];?>
                                    ...
                                    <?php $_smarty_tpl->tpl_vars['activate'] = new Smarty_variable('<%xr_translate tag="Aktivieren"%>', null, null);?>
                                    <?php if ($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_ACTIVE']=='N'){?>
                                        <?php $_smarty_tpl->tpl_vars['activate'] = new Smarty_variable('<%xr_translate tag="Deaktivieren"%>', null, null);?>
                                    <?php }?>
                                    <a title="<?php echo $_smarty_tpl->getVariable('activate')->value;?>
" class="room-edit-icon icon-switchstatus <?php if ($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_ACTIVE']=='N'){?>inactive<?php }else{ ?>active<?php }?>" href="<?php echo smarty_function_xr_genlink(array('p_id'=>32,'m_suffix'=>($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_id'])."/".($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_BESCHRIFTUNG_INTERN']),'roomId'=>$_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_id']),$_smarty_tpl);?>
">
                                        <span class="hidden"><?php echo $_smarty_tpl->getVariable('activate')->value;?>
</span>
                                    </a>
...
">
                                        <span class="hidden"><?php echo smarty_function_xr_translate(array('tag'=>"User einladen"),$_smarty_tpl);?>
</span>
                                    </a>
