<?php /* Smarty version Smarty-3.0.7, created on 2016-08-03 10:34:04
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code6gET34" */ ?>
<?php /*%%SmartyHeaderCode:48194970957a1ac7caeeff3-72450810%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9cbc7031789d0edeb3074b47fbb490b1cb65e986' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code6gET34',
      1 => 1470213244,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '48194970957a1ac7caeeff3-72450810',
  'function' => 
  array (
  ),
...
<!--     <p class="wgtest-beschreibung collapse <?php if ($_smarty_tpl->getVariable('showIntrotext')->value){?>in<?php }else{ ?>one<?php }?>" id="js-toggle-introtext"> -->
    <p class="wgtest-beschreibung collapse <?php if ($_smarty_tpl->getVariable('data')->value['frageId']==1){?>in 1<?php }else{ ?>one<?php }?>" id="js-toggle-introtext">
