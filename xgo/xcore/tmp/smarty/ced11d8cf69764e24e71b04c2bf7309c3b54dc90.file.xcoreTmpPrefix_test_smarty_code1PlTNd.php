<?php /* Smarty version Smarty-3.0.7, created on 2016-09-21 07:48:43
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1PlTNd" */ ?>
<?php /*%%SmartyHeaderCode:8889554957e23b5b752a74-90386144%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ced11d8cf69764e24e71b04c2bf7309c3b54dc90' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1PlTNd',
      1 => 1474444123,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8889554957e23b5b752a74-90386144',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                <label for="emailbenachrichtigung" style="font-size: 1.4rem;"><?php echo smarty_function_xr_translate(array('tag'=>"Emailbenachrichtigungen erlauben"),$_smarty_tpl);?>
</label>
                <select id="emailbenachrichtigung" name="EMAILBENACHRICHTIGUNG" class="form-control select-helvetica" style="font-size: 1.6rem;">
                    <option value="DE" <?php if (($_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']=='DE')){?>selected="selected"<?php }?>>DE</option>
                    <option value="EN" <?php if (($_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']=='EN')){?>selected="selected"<?php }?>>EN</option>
                    <option value="KEINE" <?php if (($_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']=='KEINE')){?>selected="selected"<?php }?>>KEINE</option>
                </select>
            </div>
