<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 15:15:00
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeW3c3uW" */ ?>
<?php /*%%SmartyHeaderCode:2077299208567809648c6769-90580130%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb787a44b0cb40a6ca8f9288f125cad6cf7c542b' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeW3c3uW',
      1 => 1450707300,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2077299208567809648c6769-90580130',
  'function' => 
  array (
  ),
...
<?php }?></span>
        ...
        <ul class="meinprofil-options">
            ...
            <div style="color:black;" class="col-xs-8">
              <span><span class="icon-duck" style="color:black;font-size:40px; margin-right:15px"></span>
              <span style="color:#04e0d7; font-size:25px;text-transform:uppercase!important;"><?php echo smarty_function_xr_translate(array('tag'=>"Hallo!"),$_smarty_tpl);?>
</span><br><?php echo smarty_function_xr_translate(array('tag'=>"Du hast deinen WG-Test noch nicht ausgeflüllt!"),$_smarty_tpl);?>
</span><br>
              <span class="hallo-headline"><?php echo smarty_function_xr_translate(array('tag'=>"Bitte investiere 5 Minuten in die Beantwortung deiner Erwartungen an deine Mitbewohner(innen)."),$_smarty_tpl);?>
<br></span>
...
"> 
                 <div class="stoerer" style="margin-top:10px;height: 80px;width: 80px; background-image: url('/xstorage/template/img/sys/delete.svg'); background-repeat: no-repeat; background-size: 80px; text-align: center;">
