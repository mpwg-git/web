<?php /* Smarty version Smarty-3.0.7, created on 2017-03-07 13:39:43
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/814.cache-3.html" */ ?>
<?php /*%%SmartyHeaderCode:46444676458beaa0f59da36-90587682%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '46444676458beaa0f59da36-90587682',
  'function' => 
  array (
  ),
    ...
    <div class="profil-inner">
        ...
        <div class="profil-inner-padding profile-inner-padding-room">
            <div class="matchinginfos">
                ...
                <span class="prozent">
                    <?php if ($_smarty_tpl->getVariable('user')->value['wz_id']==$_smarty_tpl->getVariable('room')->value['wz_ADMIN']){?>
                        <style>
                    ...
                    <?php }else{ ?>
                        <?php echo $_smarty_tpl->getVariable('data')->value['MATCHING']['RESULT']['MATCHROOM']['matchGesamt'];?>
...
-->
                <?php echo smarty_function_xr_imgWrapper(array('s_id'=>27725,'h'=>23,'ext'=>'png'),$_smarty_tpl);?>
