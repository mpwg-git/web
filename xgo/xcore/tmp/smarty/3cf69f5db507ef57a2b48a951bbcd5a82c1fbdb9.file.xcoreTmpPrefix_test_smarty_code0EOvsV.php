<?php /* Smarty version Smarty-3.0.7, created on 2015-12-15 17:12:20
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code0EOvsV" */ ?>
<?php /*%%SmartyHeaderCode:210770337556703be4217fe7-95292622%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3cf69f5db507ef57a2b48a951bbcd5a82c1fbdb9' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code0EOvsV',
      1 => 1450195940,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '210770337556703be4217fe7-95292622',
  'function' => 
  array (
  ),
...
?><?php if (isset($_SESSION['xredaktor_feUser_wsf']['SEARCH']['SEARCH_ARRAY'])){?> 
    ...
    <?php }?>
    <?php if ($_SESSION['xredaktor_feUser_wsf']['SEARCH']['SEARCH_DATA']['SEARCH']){?>
        <?php $_smarty_tpl->tpl_vars['searchSession'] = new Smarty_variable(json_decode($_SESSION['xredaktor_feUser_wsf']['SEARCH']['SEARCH_DATA']['SEARCH'],1), null, null);?>
    <?php }?>
<?php }else{ ?>
    <?php $_smarty_tpl->tpl_vars['searchSession'] = new Smarty_variable(false, null, null);?>
<?php }?>
<?php echo smarty_function_xr_print_r(array('val'=>$_SESSION['xredaktor_feUser_wsf']['SEARCH']['SEARCH_DATA']['SEARCH']),$_smarty_tpl);?>
