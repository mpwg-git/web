<?php /* Smarty version Smarty-3.0.7, created on 2016-01-14 08:14:48
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/875.cache-1.html" */ ?>
<?php /*%%SmartyHeaderCode:89233690056974ae8253425-71783296%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bddb73c4c0536678a0abdefb93e433e153789564' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/875.cache-1.html',
      1 => 1452699198,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '89233690056974ae8253425-71783296',
  'function' => 
  array (
  ),
...
';
	...
	<body>
        ...
        <script src="/xstorage/template/Darkroomjs/lib/js/plugins/darkroom.crop.js" type="text/javascript"></script>
        <script src="/xstorage/template/Darkroomjs/lib/js/plugins/darkroom.rotate.js" type="text/javascript"></script>
        <script src="/xstorage/template/Darkroomjs/lib/js/plugins/darkroom.save.js" type="text/javascript"></script>
        
        <script src="/xstorage/template/jqm-image-zoom-master/www/js/img-touch-canvas.js" type="text/javascript"></script>
        <script src="/xstorage/template/jqm-image-zoom-master/www/js/jquery.mobile-1.3.2.min.js" type="text/javascript"></script>
        <script src="/xstorage/template/jqm-image-zoom-master/www/cordova.js" type="text/javascript"></script>
        <script src="/xstorage/template/jqm-image-zoom-master/www/js/index.js" type="text/javascript"></script>
        <script src="/xstorage/template/jqm-image-zoom-master/www/js/zoom.js" type="text/javascript"></script>
