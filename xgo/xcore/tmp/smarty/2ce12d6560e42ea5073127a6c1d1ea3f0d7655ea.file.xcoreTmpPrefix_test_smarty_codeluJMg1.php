<?php /* Smarty version Smarty-3.0.7, created on 2015-12-17 19:30:09
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeluJMg1" */ ?>
<?php /*%%SmartyHeaderCode:891237005672ff31d05266-68259247%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ce12d6560e42ea5073127a6c1d1ea3f0d7655ea' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeluJMg1',
      1 => 1450377009,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '891237005672ff31d05266-68259247',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('userType')->value=='biete'){?>
 ...
 bis <?php echo $_smarty_tpl->getVariable('data')->value['USER']['wz_MIETE_BIS'];?>
    ...
    <?php echo smarty_function_xr_print_r(array('val'=>$_smarty_tpl->getVariable('data')->value['USER']['wz_ZEITRAUM_VON']),$_smarty_tpl);?>

    <?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_ZEITRAUM_VON']!='0000-00-00 00:00:00'){?>
