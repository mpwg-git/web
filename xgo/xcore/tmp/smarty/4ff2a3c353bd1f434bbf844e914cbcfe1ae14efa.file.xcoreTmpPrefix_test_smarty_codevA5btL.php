<?php /* Smarty version Smarty-3.0.7, created on 2016-09-20 14:25:18
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codevA5btL" */ ?>
<?php /*%%SmartyHeaderCode:164886970157e12aae482392-44004972%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ff2a3c353bd1f434bbf844e914cbcfe1ae14efa' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codevA5btL',
      1 => 1474374318,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '164886970157e12aae482392-44004972',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('P_ID')->value==11){?>
	...
	<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_wgtest::sc_getWgTestState','var'=>'wgTestState'),$_smarty_tpl);?>

	<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_cookie::checkFragenSession','var'=>'hasQuestionsAnsweredInSession'),$_smarty_tpl);?>



	<!--<?php if ($_REQUEST['dev']==1||($_smarty_tpl->getVariable('stillToDo')->value===true&&$_smarty_tpl->getVariable('answeredAllQuestions')->value===true)){?>-->
    ...
    <?php }elseif(($_smarty_tpl->getVariable('hasQuestionsAnswered')->value===true&&$_smarty_tpl->getVariable('wgTestState')->value!=1)){?>
        <div class="modal fade" id="noQuestionModal" tabindex="-1" role="dialog">-->
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					 Modal Header 
	...
	<?php }?>
	<!--<?php }elseif($_REQUEST['dev']==2||($_smarty_tpl->getVariable('stillToDo')->value===true&&$_smarty_tpl->getVariable('hasQuestionsAnswered')->value===true)){?>-->
	<!--    <div class="modal fade" id="noQuestionModal" tabindex="-1" role="dialog">-->
	<!--		<div class="modal-dialog" role="document">-->
	<!--			<div class="modal-content">-->
					<!-- Modal Header -->
