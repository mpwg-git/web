<?php /* Smarty version Smarty-3.0.7, created on 2016-01-13 15:57:15
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHHwT3Y" */ ?>
<?php /*%%SmartyHeaderCode:670009685569665cb4aaac2-79989656%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '35663fd71354aa4a3de02ceeef24a006c6b92c1d' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHHwT3Y',
      1 => 1452697035,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '670009685569665cb4aaac2-79989656',
  'function' => 
  array (
  ),
...
<form id="coords" class="coords" onsubmit="return false;" action="#">
	...
	<input data-crop type="hidden" size="4" id="w" name="w" value="<?php echo $_smarty_tpl->getVariable('image')->value['trueW'];?>
" />
	<input data-crop type="hidden" size="4" id="h" name="h" value="<?php echo $_smarty_tpl->getVariable('image')->value['trueH'];?>
" />
