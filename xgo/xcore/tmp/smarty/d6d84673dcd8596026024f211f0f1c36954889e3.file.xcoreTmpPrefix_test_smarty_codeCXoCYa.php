<?php /* Smarty version Smarty-3.0.7, created on 2015-11-05 18:30:25
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeCXoCYa" */ ?>
<?php /*%%SmartyHeaderCode:1507151038563b9231ebc270-28603966%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6d84673dcd8596026024f211f0f1c36954889e3' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeCXoCYa',
      1 => 1446744625,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1507151038563b9231ebc270-28603966',
  'function' => 
  array (
  ),
        ...
        <div class="form-group">
            <div class="radio">
                <label for="typ-suche" class="no-padding-left">
                    <input id="typ-suche" type="radio" name="search-type" value="suche" <?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="suche"||$_smarty_tpl->getVariable('searchSession')->value['type']==''){?> class="active" <?php }?>>
                    <span>Room</span>
                    <span class="fz">?</span>
                </label>
                <label for="typ-biete">
                    <input id="typ-biete" type="radio" name="search-type" value="biete" <?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="biete"){?> class="active" <?php }?>>
                    <span>Roomie</span>
                    <span class="fz">?</span>
                </label>
            </div>
