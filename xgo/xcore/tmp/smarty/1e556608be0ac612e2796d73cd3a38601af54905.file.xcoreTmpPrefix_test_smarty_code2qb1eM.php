<?php /* Smarty version Smarty-3.0.7, created on 2016-09-05 23:01:46
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code2qb1eM" */ ?>
<?php /*%%SmartyHeaderCode:191297623357cddd3a62e584-90806009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e556608be0ac612e2796d73cd3a38601af54905' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code2qb1eM',
      1 => 1473109306,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '191297623357cddd3a62e584-90806009',
  'function' => 
  array (
  ),
...
" class="form-control" />
    <label for="emailbenachrichtigung" style="font-size:1.3rem;padding:3px 0 0 3px;">Emailbenachrichtigungen erlauben</label>
    <select id="emailbenachrichtigung" class="form-control" name="EMAILBENACHRICHTIGUNG">
    	<option value="<?php echo $_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG'];?>
"></option>
    </select>
</div>
 <div class="form-group">
