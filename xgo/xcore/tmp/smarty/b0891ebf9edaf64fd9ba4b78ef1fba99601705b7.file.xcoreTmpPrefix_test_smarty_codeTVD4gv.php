<?php /* Smarty version Smarty-3.0.7, created on 2015-11-13 14:40:10
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeTVD4gv" */ ?>
<?php /*%%SmartyHeaderCode:16885751315645e83a6aace1-51727264%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0891ebf9edaf64fd9ba4b78ef1fba99601705b7' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeTVD4gv',
      1 => 1447422010,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16885751315645e83a6aace1-51727264',
  'function' => 
  array (
  ),
...
:</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['ZEITRAUM'];?>
 ...
 m²</span>
    ...
    <div class="fakt clearfix">
        <span class="aufzaehlung"><?php echo smarty_function_xr_translate(array('tag'=>"Vegetaroer/Veganer"),$_smarty_tpl);?>
</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_HAUSTIERE'];?>
</span>
    </div>
    <?php }?>
