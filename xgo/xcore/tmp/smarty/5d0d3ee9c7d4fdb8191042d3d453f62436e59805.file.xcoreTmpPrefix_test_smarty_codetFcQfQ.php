<?php /* Smarty version Smarty-3.0.7, created on 2016-04-30 21:08:05
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codetFcQfQ" */ ?>
<?php /*%%SmartyHeaderCode:20610017457250295236292-65730821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5d0d3ee9c7d4fdb8191042d3d453f62436e59805' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codetFcQfQ',
      1 => 1462043285,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20610017457250295236292-65730821',
  'function' => 
  array (
  ),
...
"><?php echo $_smarty_tpl->tpl_vars['o']->value['wz_TEXT'];?>
    ...
    <?php }} ?>
     ...
     <div class="row">
        <div class="col-xs-5">
            <button><?php echo smarty_function_xr_translate(array('tag'=>'Weiter mit Facebook Login'),$_smarty_tpl);?>
</button>
        </div>
        <div class="col-xs-5 pull-right">
            <button><?php echo smarty_function_xr_translate(array('tag'=>'Ich habe bereits ein Profil'),$_smarty_tpl);?>
</button>
        </div>
    </div>
