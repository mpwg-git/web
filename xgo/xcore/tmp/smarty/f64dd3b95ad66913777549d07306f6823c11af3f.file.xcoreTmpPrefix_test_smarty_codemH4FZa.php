<?php /* Smarty version Smarty-3.0.7, created on 2015-10-30 13:06:14
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codemH4FZa" */ ?>
<?php /*%%SmartyHeaderCode:171113741856335d362d3d11-46992927%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f64dd3b95ad66913777549d07306f6823c11af3f' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codemH4FZa',
      1 => 1446206774,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '171113741856335d362d3d11-46992927',
  'function' => 
  array (
  ),
...
<div class="profil suche">
    ...
    <div class="profil-inner">
        ...
        <?php if ($_smarty_tpl->getVariable('user')->value['wz_PROFILBILD']==0){?>
            <a href=""><?php echo smarty_function_xr_imgWrapper(array('s_id'=>540,'w'=>197,'h'=>197,'rmode'=>"cco",'class'=>"profileimage"),$_smarty_tpl);?>
</a>
        <?php }else{ ?>
            <a href=""><?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->getVariable('user')->value['wz_PROFILBILD'],'w'=>197,'h'=>197,'rmode'=>"cco",'class'=>"profileimage"),$_smarty_tpl);?>
</a>
        <?php }?>
