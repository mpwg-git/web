<?php /* Smarty version Smarty-3.0.7, created on 2016-09-20 15:26:31
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeqOs9jj" */ ?>
<?php /*%%SmartyHeaderCode:179750091257e13907a730f2-42812611%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c3fc48932a16dae04d72ab91173b8733d1d5e7ac' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeqOs9jj',
      1 => 1474377991,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '179750091257e13907a730f2-42812611',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('P_ID')->value==11){?>
    ...
    <?php }elseif(($_smarty_tpl->getVariable('hasQuestionsAnswered')->value===false&&$_smarty_tpl->getVariable('hasQuestionsAnsweredInSession')->value&&$_smarty_tpl->getVariable('wgteststate')->value==0)){?>	
	    <div class="modal fade" id="noQuestionModal" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
	...
	<?php }elseif($_smarty_tpl->getVariable('hasQuestionsAnswered')->value===true&&$_smarty_tpl->getVariable('wgteststate')->value==2){?>
        <div class="modal fade" id="noQuestionModal" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
