<?php /* Smarty version Smarty-3.0.7, created on 2016-09-07 19:22:24
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeOUCSck" */ ?>
<?php /*%%SmartyHeaderCode:153477298957d04cd0345125-19119992%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd698ff62ad00d5c4b9b56dbfc5d1e2b048c7ef63' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeOUCSck',
      1 => 1473268944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '153477298957d04cd0345125-19119992',
  'function' => 
  array (
  ),
...
" />
	...
	<?php echo smarty_function_xr_cssWrapperV2(array('s_ids'=>'89,15,178,11998,13331,17209,76,39,26,402,408,461,461,321','var'=>"packedcss"),$_smarty_tpl);?>
...
';
    ...
    src="https://www.facebook.com/tr?id=1029349123846307&ev=PageView&noscript=1"
    /></noscript>
	...
	<?php if ($_smarty_tpl->getVariable('P_ID')->value==52){?>
        <style>
            header nav.right-row {display: none;}
            header nav .main-nav {visibility: hidden;}
            img.503{position: relative; top: -34px; padding-left: 8px; z-index: 999;}
            .middle404container {top: -5%;}
        </style>
	<?php }?>
