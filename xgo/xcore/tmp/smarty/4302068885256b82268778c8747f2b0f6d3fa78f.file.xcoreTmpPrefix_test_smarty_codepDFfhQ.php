<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 18:06:07
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codepDFfhQ" */ ?>
<?php /*%%SmartyHeaderCode:8824592905678317fd73c93-02292606%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4302068885256b82268778c8747f2b0f6d3fa78f' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codepDFfhQ',
      1 => 1450717567,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8824592905678317fd73c93-02292606',
  'function' => 
  array (
  ),
...
:</span>
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON']!=''){?> 
                <span class="info">
                    <?php if (!$_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_BIS']&&!$_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_BIS']){?>
