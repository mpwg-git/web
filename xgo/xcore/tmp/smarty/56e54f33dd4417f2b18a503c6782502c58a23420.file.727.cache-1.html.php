<?php /* Smarty version Smarty-3.0.7, created on 2015-08-26 09:11:16
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/727.cache-1.html" */ ?>
<?php /*%%SmartyHeaderCode:135090522755dd66948e6961-72555318%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56e54f33dd4417f2b18a503c6782502c58a23420' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/727.cache-1.html',
      1 => 1440063243,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '135090522755dd66948e6961-72555318',
  'function' => 
  array (
  ),
            ...
            <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-4 col-lg-offset-4">
                <?php if ($_smarty_tpl->getVariable('result')->value['status']=='NOT_ACTIVATED'){?>
                    <div class="white-heading">
                        <span class="text"><?php echo $_smarty_tpl->getVariable('PW_VERGESSEN_HEADLINE')->value;?>
</span>
                    </div>
...
:*</label>
                	        ...
                	        <div class="error" id="feuser_email_error"><?php echo smarty_function_xr_translate(array('tag'=>'Bitte gültige E-Mail eingeben'),$_smarty_tpl);?>
</div>
                	        <button id="wz_form-login-btn" class="pull-right" style="margin-top:25px;" type="submit" title="<?php echo smarty_function_xr_translate(array('tag'=>'Absenden'),$_smarty_tpl);?>
...
" class="button pull-left" style="margin-top:25px;" target="_self" title="<?php echo smarty_function_xr_translate(array('tag'=>'zurück'),$_smarty_tpl);?>
"><?php echo smarty_function_xr_translate(array('tag'=>'zurück'),$_smarty_tpl);?>
                ...
                <?php if ($_smarty_tpl->getVariable('result')->value['status']=='USER_NOT_FOUND'){?>
                    ...
                    <a href="<?php echo smarty_function_xr_genlink(array('p_id'=>44),$_smarty_tpl);?>
...
" value="" />
                        	    <div class="error" id="<?php echo $_smarty_tpl->getVariable('form')->value;?>
