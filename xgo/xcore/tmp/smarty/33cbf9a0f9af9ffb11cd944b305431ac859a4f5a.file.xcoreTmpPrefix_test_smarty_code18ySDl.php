<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 19:21:26
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code18ySDl" */ ?>
<?php /*%%SmartyHeaderCode:194124305456784326438233-98002905%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33cbf9a0f9af9ffb11cd944b305431ac859a4f5a' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code18ySDl',
      1 => 1450722086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '194124305456784326438233-98002905',
  'function' => 
  array (
  ),
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['FRAGE']['wz_FRAGE'];?>
            ...
            <li>
                ...
                <div class="meinprofil-meinkonto-collapse collapse" id="collapseProfileKonto">
                    ...
                    <br/>
                    <div class="submitbutton-container">
                        <button id="<?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_ACTIVE']=='Y'){?>form-deactivate-account<?php }else{ ?>form-reactivate-account<?php }?>" placement="right" class="button button-default button-small">
