<?php /* Smarty version Smarty-3.0.7, created on 2016-01-20 18:50:55
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeXvstPl" */ ?>
<?php /*%%SmartyHeaderCode:38302158569fc8ff091887-64538546%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fffdac74c52d17f8c5c28c72d822299268d73ab9' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeXvstPl',
      1 => 1453312255,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '38302158569fc8ff091887-64538546',
  'function' => 
  array (
  ),
...
if ($_smarty_tpl->tpl_vars['categoryId']->total > 0){
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['categoryCheck']['last'] = $_smarty_tpl->tpl_vars['categoryId']->last;
?>
                                <p><?php echo $_smarty_tpl->getVariable('categories')->value[$_smarty_tpl->tpl_vars['categoryId']->value]['wz_KATEGORIE'];?>
<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['categoryCheck']['last']){?>,<?php }?></p>
                            <?php }} ?>
                            <div class="reporter"><?php echo smarty_function_xr_translate(array('tag'=>"mehr"),$_smarty_tpl);?>
...</div>
                        </div>
