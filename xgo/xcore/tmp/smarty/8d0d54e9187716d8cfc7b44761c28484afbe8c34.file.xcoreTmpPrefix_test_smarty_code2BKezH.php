<?php /* Smarty version Smarty-3.0.7, created on 2016-01-05 11:54:25
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code2BKezH" */ ?>
<?php /*%%SmartyHeaderCode:641650882568ba0e18665c1-98377791%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8d0d54e9187716d8cfc7b44761c28484afbe8c34' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code2BKezH',
      1 => 1451991265,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '641650882568ba0e18665c1-98377791',
  'function' => 
  array (
  ),
...
<?php if ($_SESSION[$_smarty_tpl->getVariable('sessionkey')->value]['useCookie']=='N'){?>
    <script>
        ...
        function deleteCookie(name, path, domain) {
          ...
          if (getCookie(name))
            createCookie(name, "", new Date(0).toUTCString(), path, domain);
        }
        deleteCookie('<?php echo fe_cookie::cookiename;?>
', '/')
    </script>
<?php }?>
