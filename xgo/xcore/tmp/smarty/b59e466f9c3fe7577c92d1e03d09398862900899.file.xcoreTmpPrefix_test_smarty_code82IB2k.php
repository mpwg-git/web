<?php /* Smarty version Smarty-3.0.7, created on 2015-11-18 12:50:38
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code82IB2k" */ ?>
<?php /*%%SmartyHeaderCode:1563757765564c660e53c871-10621934%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b59e466f9c3fe7577c92d1e03d09398862900899' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code82IB2k',
      1 => 1447847438,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1563757765564c660e53c871-10621934',
  'function' => 
  array (
  ),
...
<div class="input-icon search-input search-input-map <?php if ($_smarty_tpl->getVariable('inForm')->value==1){?>small v-center<?php }?>">
    <input class="form-control autocomplete-location location-start <?php if ($_smarty_tpl->getVariable('inForm')->value==1){?>in-form<?php }?>" <?php if ($_smarty_tpl->getVariable('inForm')->value==1){?>id="ADRESSE" rel="required"<?php }?> name="ADRESSE" value="<?php echo $_smarty_tpl->getVariable('adresseValue')->value;?>
