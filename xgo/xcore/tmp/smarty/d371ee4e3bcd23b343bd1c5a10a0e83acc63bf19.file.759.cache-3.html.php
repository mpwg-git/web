<?php /* Smarty version Smarty-3.0.7, created on 2016-09-21 20:54:59
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/759.cache-3.html" */ ?>
<?php /*%%SmartyHeaderCode:161510941157e2f3a35f1da8-81150923%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd371ee4e3bcd23b343bd1c5a10a0e83acc63bf19' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/759.cache-3.html',
      1 => 1474491299,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '161510941157e2f3a35f1da8-81150923',
  'function' => 
  array (
  ),
        ...
        <div class="form-group">
            <div class="radio">
                <label for="typ-suche" class="no-padding-left">
                    ...
                    <input id="typ-suche" type="radio" name="search-type" value="suche" <?php if (!isset($_smarty_tpl->tpl_vars['smarty']) || !is_array($_smarty_tpl->tpl_vars['smarty']->value)) $_smarty_tpl->createLocalArrayVariable('smarty');
if ($_smarty_tpl->tpl_vars['smarty']->value['request']['type'] = "suche"){?> class="active" <?php }?>>
                ...
                <label for="typ-biete" >
                    ...
                    <input id="typ-biete" type="radio" name="search-type" value="biete" <?php if (($_REQUEST['type']=="biete")){?> class="active" <?php }?>>
