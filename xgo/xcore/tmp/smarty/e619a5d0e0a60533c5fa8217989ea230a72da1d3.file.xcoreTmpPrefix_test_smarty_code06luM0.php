<?php /* Smarty version Smarty-3.0.7, created on 2016-08-04 11:24:31
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code06luM0" */ ?>
<?php /*%%SmartyHeaderCode:160779691457a309cf28a9d7-96644707%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e619a5d0e0a60533c5fa8217989ea230a72da1d3' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code06luM0',
      1 => 1470302671,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '160779691457a309cf28a9d7-96644707',
  'function' => 
  array (
  ),
            ...
            <?php echo smarty_function_xr_siteCall(array('fn'=>'fe_matching::sc_checkIfCurrentUserIsInMatchingToDoTable','var'=>'stillToDo'),$_smarty_tpl);?>
                  ...
                  <?php if ($_REQUEST['dev']==1||$_smarty_tpl->getVariable('stillToDo')->value===true){?>
                    ...
                    <?php }elseif($_REQUEST['dev']==2||$_smarty_tpl->getVariable('hasQuestionsAnswered')->value===false){?>
                        <!-- noQuestionModal -->
                        <div class="modal fade" id="noQuestionModal"  role="dialog" aria-hidden="true">
                            <div class="mdialog">
                                <div class="mcontent">
                                    <div class="mheader">
