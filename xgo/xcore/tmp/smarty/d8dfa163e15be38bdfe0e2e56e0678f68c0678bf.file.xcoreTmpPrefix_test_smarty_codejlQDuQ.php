<?php /* Smarty version Smarty-3.0.7, created on 2015-11-13 14:19:58
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejlQDuQ" */ ?>
<?php /*%%SmartyHeaderCode:8908982605645e37ea17819-97095476%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8dfa163e15be38bdfe0e2e56e0678f68c0678bf' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejlQDuQ',
      1 => 1447420798,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8908982605645e37ea17819-97095476',
  'function' => 
  array (
  ),
...
:</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['ZEITRAUM'];?>
 ...
 m²</span>
    ...
    <?php }?>
     ...
     <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['KAUTION']==''){?>
    <div class="fakt clearfix">
        <span class="aufzaehlung"><?php echo smarty_function_xr_translate(array('tag'=>"KAUTION"),$_smarty_tpl);?>
:</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['KAUTION'];?>
</span>
    </div>
    <?php }?>
