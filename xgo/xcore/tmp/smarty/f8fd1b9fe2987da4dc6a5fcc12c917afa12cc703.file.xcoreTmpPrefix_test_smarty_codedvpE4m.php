<?php /* Smarty version Smarty-3.0.7, created on 2015-08-19 18:34:47
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codedvpE4m" */ ?>
<?php /*%%SmartyHeaderCode:98715710555d4b0271ab602-77724907%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8fd1b9fe2987da4dc6a5fcc12c917afa12cc703' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codedvpE4m',
      1 => 1440002087,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '98715710555d4b0271ab602-77724907',
  'function' => 
  array (
  ),
...
" method="post" id="form-register">
                ...
                <div class="form-group">
                    <div class="radio">
                        <label for="suche">
                            <input id="suche" type="radio" name="TYPE" value="suche">
                            <span>Suche</span>
                            <span class="fz">?</span>
                        </label>
                        <label for="biete">
                            <input id="biete" type="radio" name="TYPE" value="biete">
                            <span>Biete</span>
                            <span class="fz">?</span>
                        </label>
                    </div>
...
*</label>
                    ...
                    <div class="error-div" id="VORNAME_error"><?php echo smarty_function_xr_translate(array('tag'=>''),$_smarty_tpl);?>
</div>
                </div>
                <div class="form-group">
...
*</label>
                    ...
                    <div class="error-div" id="NACHNAME_error"><?php echo smarty_function_xr_translate(array('tag'=>''),$_smarty_tpl);?>
</div>
                </div>
                <div class="form-group">
...
*</label>
                    ...
                    <div class="error-div" id="EMAIL_error"><?php echo smarty_function_xr_translate(array('tag'=>''),$_smarty_tpl);?>
</div>
                </div>
                <div class="form-group">
...
*</label>
                    ...
                    <div class="error-div" id="PASSWORT_error"><?php echo smarty_function_xr_translate(array('tag'=>''),$_smarty_tpl);?>
</div>
                </div>
