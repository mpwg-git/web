<?php /* Smarty version Smarty-3.0.7, created on 2015-08-10 12:42:01
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4AUU63" */ ?>
<?php /*%%SmartyHeaderCode:144795993255c87ff998eb98-07313211%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c8efddc36adfeddd8d58833d31b30b850e0e7df' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4AUU63',
      1 => 1439203321,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '144795993255c87ff998eb98-07313211',
  'function' => 
  array (
  ),
    ...
    <span class="subheadline">
        ...
        <form class="form-mein-user">
            <div class="form-group geschlecht">
                <div class="radio">
                    <label for="female">
                        <input id="female" type="radio" name="GESCHLECHT" value="female" <?php if (($_smarty_tpl->getVariable('user')->value['wz_GESCHLECHT']=='F')){?>checked="checked"<?php }?>">
                        <span class="icon-frau"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></span>
                    ...
                    <label for="male">
                        <input id="male" type="radio" name="GESCHLECHT" value="male" <?php if (($_smarty_tpl->getVariable('user')->value['wz_GESCHLECHT']=='M')){?>checked="checked"<?php }?>>
