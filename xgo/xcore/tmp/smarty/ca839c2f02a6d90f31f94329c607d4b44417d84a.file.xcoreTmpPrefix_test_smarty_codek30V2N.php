<?php /* Smarty version Smarty-3.0.7, created on 2016-09-20 09:06:40
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codek30V2N" */ ?>
<?php /*%%SmartyHeaderCode:147316553257e0e000d5ea72-16619567%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca839c2f02a6d90f31f94329c607d4b44417d84a' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codek30V2N',
      1 => 1474355200,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147316553257e0e000d5ea72-16619567',
  'function' => 
  array (
  ),
...
" class="form-control datepicker-birthday" />
            ...
            <div class="form-group">
                <?php echo smarty_function_xr_translate(array('tag'=>"Emailbenachrichtigungen erlauben"),$_smarty_tpl);?>
...
" class="form-control" />
 ...
 $_from = $_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value){
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value[$_smarty_tpl->tpl_vars['k']->value];?>
" <?php if ($_smarty_tpl->getVariable('user')->value['wz_EMAILBENACHRICHTIGUNG']==$_smarty_tpl->tpl_vars['v']->value){?>selected="selected"<?php }?><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
></option>
                    <?php }} ?>
                </select>
            </div>
