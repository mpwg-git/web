<?php /* Smarty version Smarty-3.0.7, created on 2016-01-13 10:48:01
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejLtUls" */ ?>
<?php /*%%SmartyHeaderCode:167223480856961d510fdcb8-72375152%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b2a1c26a0c8e302263f4e74e5b8795df73aba8d6' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejLtUls',
      1 => 1452678481,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '167223480856961d510fdcb8-72375152',
  'function' => 
  array (
  ),
...
<div class="meinprofil-profilbild add-image add-image-profil profileimage" data-type="profile">
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_TYPE']=='biete'&&$_smarty_tpl->getVariable('P_ID')->value==30){?>
        <?php if (empty($_smarty_tpl->getVariable('data',null,true,false)->value['IMAGES'])){?>
