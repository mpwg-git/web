<?php /* Smarty version Smarty-3.0.7, created on 2016-01-12 12:57:22
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeIa1AAl" */ ?>
<?php /*%%SmartyHeaderCode:5445368385694ea22e87670-62197437%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '94b7310b778a8ffbaaea6e6c2aa877d0074f47a5' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeIa1AAl',
      1 => 1452599842,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5445368385694ea22e87670-62197437',
  'function' => 
  array (
  ),
...
?>
    ...
    <li class="room-settings">
        <a class="room-edit <?php if ($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_ACTIVE']!='Y'){?>room-not-active<?php }?>" href="<?php echo smarty_function_xr_genlink(array('p_id'=>30,'m_suffix'=>($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_id'])."/".($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_BESCHRIFTUNG_INTERN']),'roomId'=>$_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_id']),$_smarty_tpl);?>
">
...
">
            ...
            <span class="add-edit"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></span>
        </a>
        
        <a  title="<?php echo smarty_function_xr_translate(array('tag'=>"User einladen"),$_smarty_tpl);?>
" 
            class="room-edit-icon icon-invite" 
            href="<?php echo smarty_function_xr_genlink(array('p_id'=>31,'m_suffix'=>($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_id'])."/".($_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_BESCHRIFTUNG_INTERN']),'roomId'=>$_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_id']),$_smarty_tpl);?>
">
...
" 
            class="js-delete-room-popup room-edit-icon icon-delete" 
            style="display:inline-block; cursor:pointer; padding: .6vw .22vw; margin-top: -.3vw;"
            href="#"
            data-room="<?php echo $_smarty_tpl->tpl_vars['room']->value['ROOM']['wz_id'];?>
">
