<?php /* Smarty version Smarty-3.0.7, created on 2015-11-13 16:55:29
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeBT0mtG" */ ?>
<?php /*%%SmartyHeaderCode:65314253564607f17c6458-24283847%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3a44f9f23a03e2214d976a4f2cf9625fc9314ef' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeBT0mtG',
      1 => 1447430129,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '65314253564607f17c6458-24283847',
  'function' => 
  array (
  ),
...
<?php $_smarty_tpl->tpl_vars['matching'] = new Smarty_variable($_smarty_tpl->getVariable('data')->value['MATCH'], null, null);?>
...
<?php if ($_smarty_tpl->getVariable('data')->value['USER']['ALTER']>0){?> | <?php echo $_smarty_tpl->getVariable('data')->value['USER']['ALTER'];?>
 Jahre<?php }?></p>
    ...
    <?php echo smarty_function_xr_atom(array('a_id'=>808,'matching'=>$_smarty_tpl->getVariable('data')->value['MATCH'],'return'=>1,'desc'=>'matchinginfos detail'),$_smarty_tpl);?>
