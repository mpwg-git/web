<?php /* Smarty version Smarty-3.0.7, created on 2016-01-14 18:47:54
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codezgU48S" */ ?>
<?php /*%%SmartyHeaderCode:17807897025697df4a32bdf1-71462424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '13ad7b56433d3b629a5e72b01fe33c384adef9b3' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codezgU48S',
      1 => 1452793674,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17807897025697df4a32bdf1-71462424',
  'function' => 
  array (
  ),
...
?><div class="meinprofil-profilbild add-image add-image-profil profileimage" data-type="profile">
    ...
    <?php if ($_smarty_tpl->getVariable('theType')->value=='room'){?>
        <?php if ($_smarty_tpl->getVariable('data')->value['IMAGES'][0]){?>
            <?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->getVariable('data')->value['IMAGES'][0]['wz_id'],'w'=>180,'h'=>197,'rmode'=>"cco",'class'=>"profileimage-img"),$_smarty_tpl);?>
...
<div class="maininfos">
    ...
    <?php if (!isset($_smarty_tpl->getVariable('theType',null,true,false)->value)||$_smarty_tpl->getVariable('theType')->value!='room'){?>
    <?php echo smarty_function_xr_atom(array('a_id'=>797,'user'=>$_smarty_tpl->getVariable('data')->value['USER'],'return'=>1,'desc'=>'geschlecht'),$_smarty_tpl);?>
