<?php /* Smarty version Smarty-3.0.7, created on 2017-02-28 14:32:40
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/766.cache-3.html" */ ?>
<?php /*%%SmartyHeaderCode:911169558b57bf8c21525-15725194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4901a00296203659e7424f0209c3a23f6df381d1' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/766.cache-3.html',
      1 => 1488288760,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '911169558b57bf8c21525-15725194',
  'function' => 
  array (
  ),
...
<?php if ($_REQUEST['restart']==1||$_smarty_tpl->getVariable('from_restart')->value>0){?>
...
<?php if ($_smarty_tpl->getVariable('data')->value['FRAGE']['wz_NR']>1){?>
    ...
    <?php if ($_REQUEST['restart']==1||$_smarty_tpl->getVariable('from_restart')->value>0){?>
        <a href="<?php echo smarty_function_xr_genlink(array('p_id'=>10,'frageId'=>$_smarty_tpl->getVariable('prevQuestionFrageId')->value,'restart'=>1,'m_suffix'=>($_smarty_tpl->getVariable('prevQuestionFrageId')->value)."/restart"),$_smarty_tpl);?>
...
" class="frage-button-next-question frage-wgtest-submit">
    ...
    <?php if ($_smarty_tpl->getVariable('isLastFrage')->value){?>
        <span class="save-and-back" onclick="<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_matching::doInstantMatching','var'=>'matchDone'),$_smarty_tpl);?>
"><?php echo smarty_function_xr_translate(array('tag'=>"Speichern und zurück"),$_smarty_tpl);?>
</span>
    <?php }else{ ?>
        <span class="icon-pfeil pull-right" onclick="<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_matching::doInstantMatching','var'=>'matchDone'),$_smarty_tpl);?>
"></span>    
    <?php }?>
</a>
