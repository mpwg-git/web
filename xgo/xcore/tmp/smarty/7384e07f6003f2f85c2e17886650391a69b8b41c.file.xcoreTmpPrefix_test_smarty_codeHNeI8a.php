<?php /* Smarty version Smarty-3.0.7, created on 2016-01-13 10:54:48
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHNeI8a" */ ?>
<?php /*%%SmartyHeaderCode:106550082556961ee855d944-98447883%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7384e07f6003f2f85c2e17886650391a69b8b41c' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHNeI8a',
      1 => 1452678888,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '106550082556961ee855d944-98447883',
  'function' => 
  array (
  ),
...
<div class="meinprofil-profilbild add-image add-image-profil profileimage" data-type="profile">
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_TYPE']=='biete'&&$_smarty_tpl->getVariable('P_ID')->value==30){?>
        <?php if (!$_smarty_tpl->getVariable('data')->value['IMAGES']){?>
            <?php echo smarty_function_xr_atom(array('a_id'=>878,'return'=>1,'icontype'=>'frau','showFace'=>0,'desc'=>'icon-frau'),$_smarty_tpl);?>
