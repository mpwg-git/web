<?php /* Smarty version Smarty-3.0.7, created on 2017-02-23 10:58:40
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeIYDRfj" */ ?>
<?php /*%%SmartyHeaderCode:181195460458aeb2502255c2-35735922%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f650314f111770951c4e6c0d1b2587bdf9ae4646' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeIYDRfj',
      1 => 1487843920,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '181195460458aeb2502255c2-35735922',
  'function' => 
  array (
  ),
            ...
            <!--<div class="row no-gutter">-->
                    ...
                    <div class="col-md-3">         
                        <div class="register-konto">
                            ...
                            <button style="display:none;" class="button js-simple-login" id="mail-reg-submit">Mit eMail adresse registrieren</button>
                            <button class="button js-show-simple-login" id="mail-reg-submit">Mit eMail adresse registrieren</button>
                        </div>
                    </div>
        </div>
    </form>
