<?php /* Smarty version Smarty-3.0.7, created on 2015-11-16 12:31:41
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codenpDuft" */ ?>
<?php /*%%SmartyHeaderCode:8710580375649be9d308739-68786437%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3ae86d7becc3142a737b0522fb9f0e8aeb77b283' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codenpDuft',
      1 => 1447673501,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8710580375649be9d308739-68786437',
  'function' => 
  array (
  ),
...
?><head>
    ...
    <link rel="apple-touch-icon" sizes="72x72" href="ico/apple-touch-icon-72x72-precomposed.png" />
    <link rel="apple-touch-icon" sizes="114x114" href="ico/apple-touch-icon-114x114-precomposed.png" />
    <link rel="apple-touch-icon" sizes="144x144" href="ico/apple-touch-icon-144x144-precomposed.png" />
    
    
    <link rel="icon" sizes="196x196" href="ico/apple-touch-icon.png">
