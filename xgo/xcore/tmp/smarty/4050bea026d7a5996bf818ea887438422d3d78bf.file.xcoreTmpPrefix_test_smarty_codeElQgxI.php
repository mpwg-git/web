<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 15:04:36
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeElQgxI" */ ?>
<?php /*%%SmartyHeaderCode:1540239786567806f43d4665-52232749%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4050bea026d7a5996bf818ea887438422d3d78bf' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeElQgxI',
      1 => 1450706676,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1540239786567806f43d4665-52232749',
  'function' => 
  array (
  ),
...
"> 
                 <div class="stoerer" style="margin-top:20px; position:relative;height: 120px;width: 120px; background-image: url('/xstorage/template/img/sys/delete.svg'); background-repeat: no-repeat; background-size: 120px; text-align: center;">
                    ...
                    <span style="color:white; position:absolute; top:50%; transform:translate(0,-50%);display:block;width:100%;font-size:1.9vw"><?php echo smarty_function_xr_translate(array('tag'=>"Zu den Fragen"),$_smarty_tpl);?>
</span> 
                 </div> 
                 </a>
            </div>
