<?php /* Smarty version Smarty-3.0.7, created on 2016-09-21 10:40:13
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeMIRxzs" */ ?>
<?php /*%%SmartyHeaderCode:174518085057e2638d3248b8-10582336%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cbd2a366f7506a97c95412cd182de63f4266ef16' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeMIRxzs',
      1 => 1474454413,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '174518085057e2638d3248b8-10582336',
  'function' => 
  array (
  ),
...
" class="button start-button" style="position: fixed; z-index:3; bottom: 90px; width: 280px; height: 90px; padding: 25px 0; left: 40%; margin-left: -140px; font-size: 24px; font-family: 'HelveticaNeueW01-65Medi'; font-weight: normal;">
                    <span><?php echo smarty_function_xr_translate(array('tag'=>'Anmelden'),$_smarty_tpl);?>
</span>
                </a>
                <a href="<?php echo smarty_function_xr_genlink(array('p_id'=>48),$_smarty_tpl);?>
" class="button start-button" style="position: fixed; z-index:3; bottom: 90px; width: 280px; height: 90px; left: 60%; margin-left: -140px; font-size: 24px; font-family: 'HelveticaNeueW01-65Medi'; font-weight: normal;">
                    <span><?php echo smarty_function_xr_translate(array('tag'=>'Jetzt Registrieren'),$_smarty_tpl);?>
<br /><font size="3">(<?php echo smarty_function_xr_translate(array('tag'=>'und mehr Zimmer sehen'),$_smarty_tpl);?>
)</font></span>
                </a>
            <?php }?>
