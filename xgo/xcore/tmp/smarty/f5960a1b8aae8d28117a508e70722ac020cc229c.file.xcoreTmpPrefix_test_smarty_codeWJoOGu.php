<?php /* Smarty version Smarty-3.0.7, created on 2015-03-06 20:10:03
         compiled from "/srv/gitgo_daten/www/shop.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeWJoOGu" */ ?>
<?php /*%%SmartyHeaderCode:144609688654f9fb8b9362f9-45917955%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5960a1b8aae8d28117a508e70722ac020cc229c' => 
    array (
      0 => '/srv/gitgo_daten/www/shop.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeWJoOGu',
      1 => 1425669003,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '144609688654f9fb8b9362f9-45917955',
  'function' => 
  array (
  ),
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <?php if ($_smarty_tpl->getVariable('data')->value['IS_ON_SALE']){?>
                    ...
                    <ins><?php echo $_smarty_tpl->getVariable('data')->value['wz_PRICE_SALE_EUR'];?>
</ins>
                <?php }else{ ?>
