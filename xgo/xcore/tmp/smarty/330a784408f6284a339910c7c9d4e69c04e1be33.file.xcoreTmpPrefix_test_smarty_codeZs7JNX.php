<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 13:26:30
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeZs7JNX" */ ?>
<?php /*%%SmartyHeaderCode:14385855275677eff6712508-09506507%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '330a784408f6284a339910c7c9d4e69c04e1be33' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeZs7JNX',
      1 => 1450700790,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14385855275677eff6712508-09506507',
  'function' => 
  array (
  ),
...
<div class="profil">
    ...
    1<?php echo smarty_function_xr_atom(array('a_id'=>790,'return'=>1,'matchGesamt'=>$_smarty_tpl->getVariable('matching')->value['RESULT']['MATCHROOM']['matchGesamt'],'desc'=>"matching infos",'matchType'=>'room'),$_smarty_tpl);?>
2
...
: <?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_COUNT_MITBEWOHNER_F'];?>
<br>
    <?php echo smarty_function_xr_translate(array('tag'=>'Männlich'),$_smarty_tpl);?>
: <?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_COUNT_MITBEWOHNER_M'];?>
<br>
    <br>
    ...
    <?php if (($_smarty_tpl->getVariable('data')->value['PROFILE']['MITBEWOHNER']['F']>0||$_smarty_tpl->getVariable('data')->value['PROFILE']['MITBEWOHNER']['M']>0)){?>
        <div class="mitbewohner">
            ...
            <?php echo smarty_function_xr_atom(array('a_id'=>752,'mitbewohner'=>$_smarty_tpl->getVariable('data')->value['PROFILE']['MITBEWOHNER'],'roomData'=>$_smarty_tpl->getVariable('data')->value['ROOM'],'return'=>1),$_smarty_tpl);?>
