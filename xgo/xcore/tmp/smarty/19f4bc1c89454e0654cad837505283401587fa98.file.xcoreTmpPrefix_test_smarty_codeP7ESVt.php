<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 15:01:02
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeP7ESVt" */ ?>
<?php /*%%SmartyHeaderCode:2003796595678061e19f0a3-33189838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19f4bc1c89454e0654cad837505283401587fa98' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeP7ESVt',
      1 => 1450706462,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2003796595678061e19f0a3-33189838',
  'function' => 
  array (
  ),
...
<?php }?></span>
        ...
        <ul class="meinprofil-options">
            ...
            <div style="color:white;" class="col-xs-9">
              <span><b> <span class="icon-duck" style="color:black;font-size:40px;margin-right:15px"></span><span style="color:#04e0d7; font-size:25px;text-transform:uppercase!important;"><?php echo smarty_function_xr_translate(array('tag'=>"Hallo!"),$_smarty_tpl);?>
...
"> 
                 <div class="stoerer" style="margin-top:0px;margin-left:-30px;height: 90px;width: 90px; background-image: url('/xstorage/template/img/sys/delete.svg'); background-repeat: no-repeat; background-size: 90px; text-align: center;">
                     
                    <span style="color:white;"><br><br><?php echo smarty_function_xr_translate(array('tag'=>"Zu den Fragen"),$_smarty_tpl);?>
</span> 
                 </div> 
                 </a>
            </div>
