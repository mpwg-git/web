<?php /* Smarty version Smarty-3.0.7, created on 2017-03-03 19:00:35
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codefzNpid" */ ?>
<?php /*%%SmartyHeaderCode:71155029358b9af430612a2-79692911%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70540d8ced3263f897f9ae1a143f00d068a32083' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codefzNpid',
      1 => 1488564035,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '71155029358b9af430612a2-79692911',
  'function' => 
  array (
  ),
...
. <?php echo $_smarty_tpl->tpl_vars['v']->value['FRAGE']['wz_FRAGE'];?>
                ...
                <?php }else{ ?>
                    <h4 class="frage-headline"><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
. <?php $_smarty_tpl->tpl_vars['P_ID'] = new Smarty_Variable($_smarty_tpl->getVariable('P_ID',null,true,false)->value);if ($_smarty_tpl->tpl_vars['P_ID']->value = 47){?><?php echo smarty_function_xr_translate(array('tag'=>'frage-hl-suchender'),$_smarty_tpl);?>
<?php }?><?php $_smarty_tpl->tpl_vars['P_ID'] = new Smarty_Variable($_smarty_tpl->getVariable('P_ID',null,true,false)->value);if ($_smarty_tpl->tpl_vars['P_ID']->value = 48){?><?php echo smarty_function_xr_translate(array('tag'=>'frage-hl-anbieter'),$_smarty_tpl);?>
<?php }?></h4>
                <?php }?>
                <hr>
            </div>
