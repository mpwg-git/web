<?php /* Smarty version Smarty-3.0.7, created on 2017-02-10 12:11:00
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code75RacA" */ ?>
<?php /*%%SmartyHeaderCode:1155813903589d9fc4b3b6e8-54384018%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f137132984f792507faf42260efb9ff3a65f9cdb' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code75RacA',
      1 => 1486725060,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1155813903589d9fc4b3b6e8-54384018',
  'function' => 
  array (
  ),
...
$("#btn-wgzimmer").mouseover(function(e){
    ...
    $("#btn-wgzimmer h2").css('color', '#04e0d7');
    $("#btn-wgzimmer .fp-text-small").css('color', '#04e0d7');
    $("#btn-wgzimmer button").css('background-color', '#04e0d7');
});
$("#btn-wgzimmer").mouseout(function(e){
    ...
    $("#btn-wgzimmer h2").css('color', '#646464');
        $("#btn-wgzimmer .fp-text-small").css('color', '#333');
    $("#btn-wgzimmer button").css('background-color', '#646464');
});
