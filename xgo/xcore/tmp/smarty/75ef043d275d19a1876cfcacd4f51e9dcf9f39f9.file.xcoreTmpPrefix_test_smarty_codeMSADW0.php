<?php /* Smarty version Smarty-3.0.7, created on 2016-08-03 16:36:25
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeMSADW0" */ ?>
<?php /*%%SmartyHeaderCode:186585276657a20169a168b5-18988808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75ef043d275d19a1876cfcacd4f51e9dcf9f39f9' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeMSADW0',
      1 => 1470234985,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '186585276657a20169a168b5-18988808',
  'function' => 
  array (
  ),
...
" class="navlinks active">&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Abmelden</a>
    ...
    <?php if ($_smarty_tpl->getVariable('P_ID')->value==11){?>
        ...
        <?php }elseif($_REQUEST['dev']==2||$_smarty_tpl->getVariable('hasQuestionsAnswered')->value===false){?>
            <div style="margin: 40px 0 0 0;width: 100%;background: #04e0d7;color: black;padding: 1vw 30vw;text-align: center;font-family: 'jaapokkiregular';font-weight: bold;text-transform: uppercase;">
                <br>
                <p>
