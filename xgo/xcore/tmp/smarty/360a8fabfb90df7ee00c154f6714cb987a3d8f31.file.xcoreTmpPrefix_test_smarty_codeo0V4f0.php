<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 17:47:28
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeo0V4f0" */ ?>
<?php /*%%SmartyHeaderCode:119439253356782d2014ec02-54237511%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '360a8fabfb90df7ee00c154f6714cb987a3d8f31' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeo0V4f0',
      1 => 1450716448,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '119439253356782d2014ec02-54237511',
  'function' => 
  array (
  ),
...
:</span>
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON']!=''){?><?php echo smarty_function_xr_translate(array('tag'=>'von'),$_smarty_tpl);?>
 <span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON'];?>
</span><?php }?>
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_BIS']!=''){?><?php echo smarty_function_xr_translate(array('tag'=>'bis'),$_smarty_tpl);?>
 <span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_BIS'];?>
</span><?php }?>
        </div>
    <?php }?>
