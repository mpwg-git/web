<?php /* Smarty version Smarty-3.0.7, created on 2015-11-16 09:43:13
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeY10MWv" */ ?>
<?php /*%%SmartyHeaderCode:148066106564997217ad9b2-22591360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4453e939b0a0a0c0d78a508854aaec21d5a5d08f' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeY10MWv',
      1 => 1447663393,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '148066106564997217ad9b2-22591360',
  'function' => 
  array (
  ),
    ...
    <form>
        <div class="form-group">
            ...
            <label for="typ-suche" class="no-padding-left">
                <input id="typ-suche" class="radio" type="radio" name="search-type"  value="suche" <?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="suche"||($_smarty_tpl->getVariable('searchSession')->value['type']==''&&$_smarty_tpl->getVariable('userType')->value=="suche")){?> class="active" <?php }?>>
                <span><?php echo smarty_function_xr_translate(array('tag'=>"Room"),$_smarty_tpl);?>
</span>
                <span class="fz">?</span>
            </label>
            <label for="typ-biete">
                <input id="typ-biete"  class="radio" type="radio" name="search-type" value="biete" <?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="biete"||($_smarty_tpl->getVariable('searchSession')->value['type']==''&&$_smarty_tpl->getVariable('userType')->value=="biete")){?> class="active" <?php }?>>
