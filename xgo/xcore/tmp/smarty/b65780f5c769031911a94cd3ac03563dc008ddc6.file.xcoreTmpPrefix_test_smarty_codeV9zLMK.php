<?php /* Smarty version Smarty-3.0.7, created on 2015-10-13 03:20:37
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeV9zLMK" */ ?>
<?php /*%%SmartyHeaderCode:1735329665561c5c657d8286-09701577%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b65780f5c769031911a94cd3ac03563dc008ddc6' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeV9zLMK',
      1 => 1444699237,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1735329665561c5c657d8286-09701577',
  'function' => 
  array (
  ),
    ...
    <div class="col-xs-6">
        <div class="frage-ich frage-ichbin">
            ...
            <ul class="option-container js-options-bin">
                <li class="option<?php if ($_smarty_tpl->getVariable('data')->value['wz_ANTWORT_BIN']==$_smarty_tpl->getVariable('option_wz_id')->value[0]){?> active<?php }?>" data-id="<?php echo $_smarty_tpl->getVariable('option_wz_id')->value[0];?>
">a</li>
                <li class="option<?php if ($_smarty_tpl->getVariable('data')->value['wz_ANTWORT_BIN']==$_smarty_tpl->getVariable('option_wz_id')->value[1]){?> active<?php }?>" data-id="<?php echo $_smarty_tpl->getVariable('option_wz_id')->value[1];?>
">b</li>
                
                <?php if ($_smarty_tpl->getVariable('option_wz_id')->value[2]){?>
                    <li class="option<?php if ($_smarty_tpl->getVariable('data')->value['wz_ANTWORT_BIN']==$_smarty_tpl->getVariable('option_wz_id')->value[2]){?> active<?php }?>" data-id="<?php echo $_smarty_tpl->getVariable('option_wz_id')->value[2];?>
">c</li>
                <?php }?>
    ...
    <div class="col-xs-6">
        <div class="frage-du frage-ichwuensche">
            ...
            <ul class="option-container js-options-suche">
                <li class="option<?php if ($_smarty_tpl->getVariable('data')->value['wz_ANTWORT_SUCHE']==$_smarty_tpl->getVariable('option_wz_id')->value[0]){?> active<?php }?>" data-id="<?php echo $_smarty_tpl->getVariable('option_wz_id')->value[0];?>
">a</li>
                <li class="option<?php if ($_smarty_tpl->getVariable('data')->value['wz_ANTWORT_SUCHE']==$_smarty_tpl->getVariable('option_wz_id')->value[1]){?> active<?php }?>" data-id="<?php echo $_smarty_tpl->getVariable('option_wz_id')->value[1];?>
">b</li>
                <?php if ($_smarty_tpl->getVariable('option_wz_id')->value[2]){?>
                    <li class="option<?php if ($_smarty_tpl->getVariable('data')->value['wz_ANTWORT_BIN']==$_smarty_tpl->getVariable('option_wz_id')->value[2]){?> active<?php }?>" data-id="<?php echo $_smarty_tpl->getVariable('option_wz_id')->value[2];?>
">c</li>    
