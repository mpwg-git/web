<?php /* Smarty version Smarty-3.0.7, created on 2015-11-23 15:55:03
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeu1HiuU" */ ?>
<?php /*%%SmartyHeaderCode:1450468071565328c70778a0-07514557%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a1e33921da623ba896533db0afd6d00b42a7c81f' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeu1HiuU',
      1 => 1448290503,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1450468071565328c70778a0-07514557',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('data')->value['USER']['ALTER']>0){?> | <?php echo $_smarty_tpl->getVariable('data')->value['USER']['ALTER'];?>
 Jahre<?php }?></p>
    ...
    <?php echo smarty_function_xr_atom(array('a_id'=>702,'user'=>$_smarty_tpl->getVariable('data')->value['USER'],'data'=>$_smarty_tpl->getVariable('data')->value,'theType'=>'room','return'=>1),$_smarty_tpl);?>
