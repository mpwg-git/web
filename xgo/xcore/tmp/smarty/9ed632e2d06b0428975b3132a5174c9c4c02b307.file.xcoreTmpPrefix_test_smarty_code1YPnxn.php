<?php /* Smarty version Smarty-3.0.7, created on 2015-12-17 19:39:08
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1YPnxn" */ ?>
<?php /*%%SmartyHeaderCode:18771608615673014c2a6d77-36169684%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ed632e2d06b0428975b3132a5174c9c4c02b307' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1YPnxn',
      1 => 1450377548,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18771608615673014c2a6d77-36169684',
  'function' => 
  array (
  ),
...
:</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['ZEITRAUM'];?>
 ...
 m²</span>
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ADRESSE']!=''){?>
        <div id="map" data-adress="<?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_ADRESSE'];?>
"></div>
        <script>
            top.showOnMap = {
