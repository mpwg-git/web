<?php /* Smarty version Smarty-3.0.7, created on 2016-08-12 20:49:01
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codezIJBva" */ ?>
<?php /*%%SmartyHeaderCode:143235203857ae1a1d48d9e6-84905007%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38c08cded08df5333d0834913f15f3d83aef271c' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codezIJBva',
      1 => 1471027741,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '143235203857ae1a1d48d9e6-84905007',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                ...
                <label for="emailja" class="radio special-label">
                    <input id="emailja" type="radio" name="EMAILNOTIFICATION" value="Y" checked="checked">
                ...
                <label for="emailnein" class="radio special-label">
                    <input id="emailnein" type="radio" name="EMAILNOTIFICATION" value="N" checked="checked">
