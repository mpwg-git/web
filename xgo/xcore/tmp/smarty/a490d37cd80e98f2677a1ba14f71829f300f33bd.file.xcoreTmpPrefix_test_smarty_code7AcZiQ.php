<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 17:49:06
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7AcZiQ" */ ?>
<?php /*%%SmartyHeaderCode:209223676956782d8221c2f6-34323559%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a490d37cd80e98f2677a1ba14f71829f300f33bd' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7AcZiQ',
      1 => 1450716546,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '209223676956782d8221c2f6-34323559',
  'function' => 
  array (
  ),
...
:</span>
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON']!=''){?> <span class="info"><?php echo smarty_function_xr_translate(array('tag'=>'von'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON'];?>
</span><?php }?>
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_VON']&&$_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_BIS']){?><span class="info">-</span><?php }?>
            <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ZEITRAUM_BIS']!=''){?><span class="info"><?php echo smarty_function_xr_translate(array('tag'=>'bis'),$_smarty_tpl);?>
