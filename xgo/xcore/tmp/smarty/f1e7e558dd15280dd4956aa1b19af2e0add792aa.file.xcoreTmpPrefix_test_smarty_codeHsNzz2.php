<?php /* Smarty version Smarty-3.0.7, created on 2015-08-19 10:01:24
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHsNzz2" */ ?>
<?php /*%%SmartyHeaderCode:123458797455d437d498a905-50190121%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f1e7e558dd15280dd4956aa1b19af2e0add792aa' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHsNzz2',
      1 => 1439971284,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '123458797455d437d498a905-50190121',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('data')->value['PROFILE']['wz_ADRESSE_LAT']!=0&&$_smarty_tpl->getVariable('data')->value['PROFILE']['wz_ADRESSE_LNG']!=0){?>
    ...
    <script>
         $(document).ready(function(){
        	fe_map.centerMapOnPointSimple(<?php echo $_smarty_tpl->getVariable('data')->value['PROFILE']['wz_ADRESSE_LAT'];?>
, <?php echo $_smarty_tpl->getVariable('data')->value['PROFILE']['wz_ADRESSE_LNG'];?>
);
        });
    </script>
