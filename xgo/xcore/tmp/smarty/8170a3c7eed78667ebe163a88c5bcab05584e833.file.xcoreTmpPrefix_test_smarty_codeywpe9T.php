<?php /* Smarty version Smarty-3.0.7, created on 2017-02-23 10:57:32
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeywpe9T" */ ?>
<?php /*%%SmartyHeaderCode:63967707158aeb20cb16c79-26291654%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8170a3c7eed78667ebe163a88c5bcab05584e833' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeywpe9T',
      1 => 1487843852,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '63967707158aeb20cb16c79-26291654',
  'function' => 
  array (
  ),
            ...
            <!--<div class="row no-gutter">-->
                    ...
                    <div class="col-md-3">         
                        <div class="register-konto">
                            ...
                            <button style="display:none;" class="button start-button js-simple-login" id="mail-reg-submit">Mit eMail adresse registrieren</button>
                            <button class="button start-button js-show-simple-login" id="mail-reg-submit">Mit eMail adresse registrieren</button>
                        </div>
                    </div>
        </div>
    </form>
