<?php /* Smarty version Smarty-3.0.7, created on 2017-03-02 13:58:21
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeYbnwId" */ ?>
<?php /*%%SmartyHeaderCode:137473837758b816ed20cf13-92854652%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ac9938c38fc4018e985cc4ae07a3b61c65625c9' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeYbnwId',
      1 => 1488459501,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '137473837758b816ed20cf13-92854652',
  'function' => 
  array (
  ),
        ...
        <div class="row no-gutter">
            <div class="col-xs-12 antwort-value">
                <div class="radio radio-inline">
                    <label for="<?php echo $_smarty_tpl->tpl_vars['v']->value['FRAGE']['wz_NR'];?>
">
                        <input type="radio" name="frage_1"></label>
                        <input type="radio" name="frage_1">
                        <input type="radio" name="frage_1">
                        <input type="radio" name="frage_1">
                        <input type="radio" name="frage_1">
                    </label>
