<?php /* Smarty version Smarty-3.0.7, created on 2016-09-20 14:39:57
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code24gEiH" */ ?>
<?php /*%%SmartyHeaderCode:169478798057e12e1d8fbd22-27737765%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6bd6f14f460d2761e9dabb23256160855ccc279b' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code24gEiH',
      1 => 1474375197,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169478798057e12e1d8fbd22-27737765',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('P_ID')->value==11){?>
	...
	<?php }elseif($_smarty_tpl->getVariable('wgTestState')->value==0||($_smarty_tpl->getVariable('hasQuestionsAnswered')->value===false&&$_smarty_tpl->getVariable('hasQuestionsAnsweredInSession')->value)){?>
	    	    <div class="modal fade" id="noQuestionModal" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
