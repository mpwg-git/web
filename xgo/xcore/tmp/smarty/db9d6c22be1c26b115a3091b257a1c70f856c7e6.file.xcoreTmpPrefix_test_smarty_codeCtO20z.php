<?php /* Smarty version Smarty-3.0.7, created on 2016-07-09 10:33:56
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeCtO20z" */ ?>
<?php /*%%SmartyHeaderCode:12254839885780b6f40c2472-50754128%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db9d6c22be1c26b115a3091b257a1c70f856c7e6' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeCtO20z',
      1 => 1468053236,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12254839885780b6f40c2472-50754128',
  'function' => 
  array (
  ),
...
" target="_blank"  style="text-decoration:underline;"><?php echo smarty_function_xr_translate(array('tag'=>"AGB"),$_smarty_tpl);?>
        ...
        <div class="row" style="padding-top: 18px; display:none;" id="show-simple-login-form">
            ...
            <div class="col-xs-12 pull-right register-inner" style="max-width: 360px;">
...
" class="forgotpw"><?php echo smarty_function_xr_translate(array('tag'=>"Passwort vergessen?"),$_smarty_tpl);?>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-5 pull-right" style="text-align: right; padding-right: 0px;">
