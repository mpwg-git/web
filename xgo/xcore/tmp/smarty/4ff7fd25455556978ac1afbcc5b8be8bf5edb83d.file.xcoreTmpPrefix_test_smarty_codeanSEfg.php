<?php /* Smarty version Smarty-3.0.7, created on 2015-07-02 11:18:55
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeanSEfg" */ ?>
<?php /*%%SmartyHeaderCode:1863344435559501ff747da0-12941491%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ff7fd25455556978ac1afbcc5b8be8bf5edb83d' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeanSEfg',
      1 => 1435828735,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1863344435559501ff747da0-12941491',
  'function' => 
  array (
  ),
    ...
    <div class="mainform">
        <form class="" name="">
            ...
            <div class="form-group">
                ...
                <label for="female" class="radio">
                    <input id="female" type="radio" name="mitbewohne" checked/>
                    <span class="checked icon-frau"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></span>
                    <span class="unchecked icon-frau_outline"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></span>
                </label>
                <label for="male" class="radio">
                    <input id="male" type="radio" name="mitbewohne" />
                    <span class="checked icon-mann"><span class="path1"></span><span class="path2"></span></span>
                    <span class="unchecked icon-mann_outline"><span class="path1"></span><span class="path2"></span></span>
                </label>
            </div>
            ...
            <div class="form-group clearfix">
                <a href="" class="button button-md pull-right">Speichern</a>
            </div>
        </form>
    </div>
