<?php /* Smarty version Smarty-3.0.7, created on 2016-09-20 15:23:43
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeYDyvaB" */ ?>
<?php /*%%SmartyHeaderCode:105905533457e1385f2d1bd8-73392004%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '42c4ba584466f13be9ce5b6dcac843bf1c137910' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeYDyvaB',
      1 => 1474377823,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '105905533457e1385f2d1bd8-73392004',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('P_ID')->value==11){?>
	...
	<!--<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_wgtest::answeredQuestionsState','var'=>'state'),$_smarty_tpl);?>
-->
	<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_cookie::checkFragenSession','var'=>'hasQuestionsAnsweredInSession'),$_smarty_tpl);?>

    <?php echo smarty_function_xr_siteCall(array('fn'=>"fe_wgtest::sc_getWgTestState",'userId'=>$_SESSION['xredaktor_feUser_wsf']['wz_id'],'var'=>'state'),$_smarty_tpl);?>

    
<span style="color: white;">TEST</span>

    <?php if ($_smarty_tpl->getVariable('state')->value==0){?>
        <span style="color: white;">wgTestState: 0</span>
    <?php }elseif($_smarty_tpl->getVariable('state')->value==1){?>
        <span style="color: white;">wgTestState: 1</span>
    <?php }elseif($_smarty_tpl->getVariable('state')->value==2){?>
        <span style="color: white;">wgTestState: 2</span>
    <?php }?>
...
-->
	...
	<!--								    <span><?php echo smarty_function_xr_translate(array('tag'=>'Mein Profil'),$_smarty_tpl);?>
</span>-->
	<!--								</div>-->
	<!--						    </a>-->
...
-->
 ...
 <!--                           <?php }?>-->
	...
	<!--		</div>-->
	<!--	</div>-->
	<!--<?php }elseif($_smarty_tpl->getVariable('hasQuestionsAnswered')->value===true){?>-->
 <!--       <div class="modal fade" id="noQuestionModal" tabindex="-1" role="dialog">-->
	<!--		<div class="modal-dialog" role="document">-->
	<!--			<div class="modal-content">-->
	<!--				<div class="modal-header">-->
