<?php /* Smarty version Smarty-3.0.7, created on 2015-10-13 05:52:05
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeZQyfpf" */ ?>
<?php /*%%SmartyHeaderCode:1735341343561c7fe572fa97-60936535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e1728231700101d3b00663f2194d2b646819fb08' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeZQyfpf',
      1 => 1444708325,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1735341343561c7fe572fa97-60936535',
  'function' => 
  array (
  ),
        ...
        <div class="form-group">
            <div class="radio">
                <label for="typ-suche" class="no-padding-left">
                    <input id="typ-suche" type="radio" name="search-type" value="suche">
                    <span <?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="suche"||$_smarty_tpl->getVariable('searchSession')->value['type']==''){?> class="active" <?php }?>>Room</span>
                    <span class="fz">?</span>
                </label>
                <label for="typ-biete">
                    <input id="typ-biete" type="radio" name="search-type" value="biete">
                    <span <?php if ($_smarty_tpl->getVariable('searchSession')->value['type']=="biete"){?> class="active" <?php }?>>Roomie</span>
                    <span class="fz">?</span>
                </label>
            </div>
        </div>
