<?php /* Smarty version Smarty-3.0.7, created on 2015-08-10 11:21:37
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeomGtXc" */ ?>
<?php /*%%SmartyHeaderCode:32556813555c86d21781f46-64464607%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c46591bfe19f9d4b1278619eec798628cfcb1881' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeomGtXc',
      1 => 1439198497,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32556813555c86d21781f46-64464607',
  'function' => 
  array (
  ),
 ...
 €?" />
        ...
        <div class="form-group geschlecht-container">
            ...
            <label for="mitbew-female" class="radio special-label">
                <input id="mitbew-female" type="radio" name="mitbewohner" <?php if ($_smarty_tpl->getVariable('profile')->value['wz_MITBEWOHNER']=='F'){?><?php }?>/>
                <span class="checked icon-frau"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></span>
                <span class="unchecked icon-frau_outline"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></span>
            </label>
            <label for="mitbew-male" class="radio special-label">
                <input id="mitbew-male" type="radio" name="mitbewohner"  value="<?php echo $_smarty_tpl->getVariable('profile')->value[''];?>
"/>
