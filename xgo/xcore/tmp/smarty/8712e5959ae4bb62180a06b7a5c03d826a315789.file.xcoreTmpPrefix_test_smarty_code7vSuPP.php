<?php /* Smarty version Smarty-3.0.7, created on 2016-01-13 11:01:04
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7vSuPP" */ ?>
<?php /*%%SmartyHeaderCode:57714934656962060c5e1b9-24223475%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8712e5959ae4bb62180a06b7a5c03d826a315789' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7vSuPP',
      1 => 1452679264,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '57714934656962060c5e1b9-24223475',
  'function' => 
  array (
  ),
...
<div class="meinprofil-profilbild add-image add-image-profil profileimage" data-type="profile">
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_TYPE']=='biete'&&$_smarty_tpl->getVariable('P_ID')->value==30){?>
        <?php if (!$_smarty_tpl->getVariable('data')->value['IMAGES']){?>
            <?php echo smarty_function_xr_atom(array('a_id'=>878,'return'=>1,'icontype'=>'mann','showFace'=>0,'desc'=>'fallback-icon'),$_smarty_tpl);?>
