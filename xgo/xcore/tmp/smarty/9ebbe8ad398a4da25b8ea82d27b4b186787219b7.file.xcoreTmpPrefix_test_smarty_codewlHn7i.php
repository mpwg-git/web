<?php /* Smarty version Smarty-3.0.7, created on 2015-08-17 20:00:50
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codewlHn7i" */ ?>
<?php /*%%SmartyHeaderCode:90273767255d22152af6cf1-83252396%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ebbe8ad398a4da25b8ea82d27b4b186787219b7' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codewlHn7i',
      1 => 1439834450,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '90273767255d22152af6cf1-83252396',
  'function' => 
  array (
  ),
...
<div class="input-icon search-input search-input-map <?php if ($_smarty_tpl->getVariable('inForm')->value==1){?>small v-center<?php }?>">
    <input class="form-control autocomplete-location" name="ADRESSE" <?php if ($_smarty_tpl->getVariable('inForm')->value==1){?>value="<?php echo $_smarty_tpl->getVariable('profileData')->value['wz_ADRESSE'];?>
