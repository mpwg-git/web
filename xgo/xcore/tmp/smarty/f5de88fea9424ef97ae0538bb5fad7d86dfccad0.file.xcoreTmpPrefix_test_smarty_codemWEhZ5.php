<?php /* Smarty version Smarty-3.0.7, created on 2016-08-12 11:00:14
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codemWEhZ5" */ ?>
<?php /*%%SmartyHeaderCode:174629124357ad901edf0280-30179337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5de88fea9424ef97ae0538bb5fad7d86dfccad0' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codemWEhZ5',
      1 => 1470992414,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '174629124357ad901edf0280-30179337',
  'function' => 
  array (
  ),
	    ...
	    <div class="modal-content">
	        <div class="modal-header">
	            ...
	            <a href="/de/mein-profil/wg-test">
		            <div style=" background: url('/xstorage/template/img/sys/delete.svg'); width: 100px; height: 100px;display: inline-block; position: relative; vertical-align: bottom;">
	      ...
	      <div class="modal-body">
	          <p>
                  ...
                  <?php echo smarty_function_xr_translate(array('tag'=>'Dr. Duck kann dir deswegen nicht sagen, wer am besten zu dir passt!'),$_smarty_tpl);?>
					...
					<!--<p>-->
					<!--    <?php echo smarty_function_xr_translate(array('tag'=>'Du hast deine WG-Fragen noch nicht ausgefüllt!-->
					<!--	<br>-->
					<!--	Bitte investiere 5 Minuten in die Beantwortung deiner Erwartungen an deine Mitbewohner(innen).-->
					<!--	<br>-->
					<!--	Dann können wir den perfekten Match für dich finden!'),$_smarty_tpl);?>
-->
					<!--</p>-->
	      </div>
	      <div class="modal-footer">
