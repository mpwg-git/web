<?php /* Smarty version Smarty-3.0.7, created on 2016-09-21 20:30:14
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeJe3Ixb" */ ?>
<?php /*%%SmartyHeaderCode:131661389857e2edd6032222-17759014%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c094a13809df38d300dfbc8eaeea37a6b314327' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeJe3Ixb',
      1 => 1474489813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '131661389857e2edd6032222-17759014',
  'function' => 
  array (
  ),
        ...
        <div class="form-group">
            <div class="radio">
                <label for="typ-suche" class="no-padding-left">
                    ...
                    <input id="typ-suche" type="radio" name="search-type" value="suche" <?php if ($_smarty_tpl->getVariable('userType')->value=="suche"){?> class="active" <?php }?>>
                ...
                <label for="typ-biete" >
                    ...
                    <input id="typ-biete" type="radio" name="search-type" value="biete" <?php if ($_smarty_tpl->getVariable('userType')->value=="biete"){?> class="active" <?php }?>>
