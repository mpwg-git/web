<?php /* Smarty version Smarty-3.0.7, created on 2016-01-14 13:06:19
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeNxIOFl" */ ?>
<?php /*%%SmartyHeaderCode:212092715556978f3b3118f2-39175746%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '16780dd4c93f160b4c7072872c76d2377e950f6e' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeNxIOFl',
      1 => 1452773179,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '212092715556978f3b3118f2-39175746',
  'function' => 
  array (
  ),
...
.
                        ...
                        <?php if (count($_smarty_tpl->getVariable('wgtestdata')->value)<$_smarty_tpl->getVariable('fragenGesamt')->value){?>
                            <a class="button" href="<?php echo smarty_function_xr_genlink(array('p_id'=>10),$_smarty_tpl);?>
"><?php echo smarty_function_xr_translate(array('tag'=>"Fortsetzen bei nächster unbeantworteten Frage"),$_smarty_tpl);?>
</a>
                        <?php }?>
                        
                        <?php if (count($_smarty_tpl->getVariable('wgtestdata')->value)==$_smarty_tpl->getVariable('fragenGesamt')->value){?>
                            <a class="button" href=""><?php echo smarty_function_xr_translate(array('tag'=>"Alle Fragen noch einmal durchgehen"),$_smarty_tpl);?>
</a>
                        <?php }?>
