<?php /* Smarty version Smarty-3.0.7, created on 2015-11-16 12:48:07
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1tiPFh" */ ?>
<?php /*%%SmartyHeaderCode:5585339765649c277c54c91-59081327%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af7c030022b45a9b3b62a8ec39d3c8cee1985448' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1tiPFh',
      1 => 1447674487,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5585339765649c277c54c91-59081327',
  'function' => 
  array (
  ),
...
?><head>
	...
	<link rel="apple-touch-icon" href="/xstorage/template/img/favicon/apple-touch-icon-114x114.png" />
    <link rel="apple-touch-icon" sizes="72x72" href="/xstorage/template/img/favicon/apple-touch-icon-114x114.png" />
    <link rel="apple-touch-icon" sizes="114x114" href="/xstorage/template/img/favicon/apple-touch-icon-114x114.png" />
    <link rel="apple-touch-icon" sizes="144x144" href="/xstorage/template/img/favicon/apple-touch-icon-114x114.png" />
    
    
    <link rel="icon" sizes="196x196" href="/xstorage/template/img/favicon/apple-touch-icon.png">
