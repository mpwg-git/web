<?php /* Smarty version Smarty-3.0.7, created on 2015-08-19 18:39:57
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeFNLZkj" */ ?>
<?php /*%%SmartyHeaderCode:113004643055d4b15d5eb395-33152999%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '76453a07feee05f26c563610fdd9922d2fe4f5d6' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeFNLZkj',
      1 => 1440002397,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '113004643055d4b15d5eb395-33152999',
  'function' => 
  array (
  ),
...
" method="post" id="form-register">
                ...
                <div class="geschlecht-chooser">
                    <div class="form-group">
                        <div class="radio">
                            <label for="female">
                                <input id="female" type="radio" name="GESCHLECHT" value="female" rel="required_oneofmany">
                            ...
                            <label for="male">
                                <input id="male" type="radio" name="GESCHLECHT" value="male"  rel="required_oneofmany">
                ...
                <div class="form-group">
                    <div class="radio">
                        <label for="suche">
                            <input id="suche" type="radio" name="TYPE" value="suche" rel="required_oneofmany">
                            <span>Suche</span>
                            <span class="fz">?</span>
                        </label>
                        <label for="biete">
                            <input id="biete" type="radio" name="TYPE" value="biete" rel="required_oneofmany">
                            <span>Biete</span>
                            <span class="fz">?</span>
                        </label>
                    </div>
