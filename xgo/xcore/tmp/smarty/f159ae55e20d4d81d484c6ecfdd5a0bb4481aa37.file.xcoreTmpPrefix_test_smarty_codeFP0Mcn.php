<?php /* Smarty version Smarty-3.0.7, created on 2016-06-16 19:19:02
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeFP0Mcn" */ ?>
<?php /*%%SmartyHeaderCode:9306026765762df86373b91-38782484%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f159ae55e20d4d81d484c6ecfdd5a0bb4481aa37' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeFP0Mcn',
      1 => 1466097542,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9306026765762df86373b91-38782484',
  'function' => 
  array (
  ),
...
" target="_blank"  style="text-decoration:underline;"><?php echo smarty_function_xr_translate(array('tag'=>"AGB"),$_smarty_tpl);?>
    ...
    <div class="row" style="padding-top: 18px; display:none;" id="show-simple-login-form">
        ...
        <div class="col-xs-5 pull-right register-inner" style="max-width: 360px;">
...
*</label>
            ...
            <div class="form-group">
                ...
                <div class="error-div" id="v2_PASSWORT_wrong_error"><?php echo smarty_function_xr_translate(array('tag'=>'Das eingegebene Passwort ist leider falsch'),$_smarty_tpl);?>
</div>
