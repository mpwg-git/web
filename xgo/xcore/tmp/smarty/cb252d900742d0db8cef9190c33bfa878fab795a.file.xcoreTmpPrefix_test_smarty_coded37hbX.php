<?php /* Smarty version Smarty-3.0.7, created on 2016-09-21 20:30:35
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_coded37hbX" */ ?>
<?php /*%%SmartyHeaderCode:109059030157e2edebd8e987-83650132%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb252d900742d0db8cef9190c33bfa878fab795a' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_coded37hbX',
      1 => 1474489835,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '109059030157e2edebd8e987-83650132',
  'function' => 
  array (
  ),
        ...
        <div class="form-group">
            <div class="radio">
                <label for="typ-suche" class="no-padding-left">
                    ...
                    <input id="typ-suche" type="radio" name="search-type" value="suche" <?php if ($_smarty_tpl->getVariable('type')->value=="suche"){?> class="active" <?php }?>>
                ...
                <label for="typ-biete" >
                    ...
                    <input id="typ-biete" type="radio" name="search-type" value="biete" <?php if ($_smarty_tpl->getVariable('type')->value=="biete"){?> class="active" <?php }?>>
