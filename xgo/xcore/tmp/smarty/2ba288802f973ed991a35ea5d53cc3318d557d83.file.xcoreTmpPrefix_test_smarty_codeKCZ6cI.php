<?php /* Smarty version Smarty-3.0.7, created on 2017-03-07 14:13:46
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeKCZ6cI" */ ?>
<?php /*%%SmartyHeaderCode:154378889658beb20aa019d0-29694817%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ba288802f973ed991a35ea5d53cc3318d557d83' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeKCZ6cI',
      1 => 1488892426,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '154378889658beb20aa019d0-29694817',
  'function' => 
  array (
  ),
                            ...
                            <div class="inner clearfix">
                                <div class="item">
                                    ...
                                    <?php $_smarty_tpl->tpl_vars['from'] = new Smarty_Variable($_smarty_tpl->getVariable('from',null,true,false)->value);if ($_smarty_tpl->tpl_vars['from']->value = 'FAVS'){?>
                                        <?php echo smarty_function_xr_atom(array('a_id'=>769,'showFace'=>3,'theType'=>'room','state'=>$_smarty_tpl->getVariable('roomState')->value['FAV'],'userId'=>$_smarty_tpl->getVariable('data')->value['ID'],'addClass'=>"js-toggle-fade",'return'=>1,'desc'=>"fav icon"),$_smarty_tpl);?>

                                    <?php }else{ ?>
                                        <?php echo smarty_function_xr_atom(array('a_id'=>769,'showFace'=>3,'theType'=>'room','state'=>$_smarty_tpl->getVariable('roomState')->value['FAV'],'userId'=>$_smarty_tpl->getVariable('data')->value['ID'],'return'=>1,'desc'=>"fav icon"),$_smarty_tpl);?>

                                    <?php }?>
                                </div>
                                <div class="item">
                                    <!-- 685 desktop -->
                                    <?php echo smarty_function_xr_atom(array('a_id'=>770,'showFace'=>3,'theType'=>'room','state'=>$_smarty_tpl->getVariable('roomState')->value['BLOCK'],'userId'=>$_smarty_tpl->getVariable('data')->value['ID'],'addClass'=>"js-toggle-fade",'return'=>1,'desc'=>"block icon"),$_smarty_tpl);?>
