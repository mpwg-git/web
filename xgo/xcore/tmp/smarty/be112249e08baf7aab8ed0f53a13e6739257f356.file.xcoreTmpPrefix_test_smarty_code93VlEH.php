<?php /* Smarty version Smarty-3.0.7, created on 2017-02-23 14:10:55
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code93VlEH" */ ?>
<?php /*%%SmartyHeaderCode:28688683458aedf5fa03df2-28423550%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'be112249e08baf7aab8ed0f53a13e6739257f356' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code93VlEH',
      1 => 1487855455,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28688683458aedf5fa03df2-28423550',
  'function' => 
  array (
  ),
        ...
        <div class="col-md-3">
            <div class="register-wunsch-wg">
                ...
                <div class="error-div" id="ADRESSE_error">
                    ...
                    <span class="error-message"><?php echo smarty_function_xr_translate(array('tag'=>'Bitte Adresse angeben'),$_smarty_tpl);?>
</span>
                </div>
                ...
                <div id="register-inner-inner" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form method="post" id="wg-zimmer-finden">
                            <div class="form-group">
                                <label class="radio-inline"><input type="radio" name="optradio"><h5>WEIBLICH</h5></label>
                                <label class="radio-inline"><input type="radio" name="optradio"><h5>MÄNNLICH</h5></label>
                            </div>
                            <div class="form-group">
