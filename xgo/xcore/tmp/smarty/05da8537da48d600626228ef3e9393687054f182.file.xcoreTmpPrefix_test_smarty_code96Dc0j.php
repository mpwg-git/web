<?php /* Smarty version Smarty-3.0.7, created on 2015-08-19 09:52:37
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code96Dc0j" */ ?>
<?php /*%%SmartyHeaderCode:18058396555d435c5cd81c2-28192107%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05da8537da48d600626228ef3e9393687054f182' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code96Dc0j',
      1 => 1439970757,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18058396555d435c5cd81c2-28192107',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('data')->value['PROFILE']['wz_ADRESSE_LAT']!=0&&$_smarty_tpl->getVariable('data')->value['PROFILE']['wz_ADRESSE_LNG']!=0){?>
    ...
    <script>
         $(document).ready(function(){
        	fe_map.centerMapOnPoint($data['PROFILE']['wz_ADRESSE_LAT'], $data['PROFILE']['wz_ADRESSE_LNG']);
        });
    </script>
