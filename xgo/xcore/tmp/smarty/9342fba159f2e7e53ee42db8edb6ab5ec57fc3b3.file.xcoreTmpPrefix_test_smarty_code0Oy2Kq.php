<?php /* Smarty version Smarty-3.0.7, created on 2015-11-25 10:34:31
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code0Oy2Kq" */ ?>
<?php /*%%SmartyHeaderCode:323039381565580a7e97982-81568604%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9342fba159f2e7e53ee42db8edb6ab5ec57fc3b3' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code0Oy2Kq',
      1 => 1448444071,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '323039381565580a7e97982-81568604',
  'function' => 
  array (
  ),
    ...
    <?php if ($_smarty_tpl->getVariable('P_ID')->value==17){?>
        ...
        <?php if ($_REQUEST['dev']==1||$_smarty_tpl->getVariable('stillToDo')->value===true){?>
            <div style=" margin: 40px 0 0 0; width: 100%; background: #04e0d7; color: black; padding: 5px; text-align: center; font-family: 'jaapokkiregular'; font-weight: bold; text-transform: uppercase;">
                <br>
                <p>
                    Dr. Duck vergleicht dich gerade mit 12.345 weiteren Profilen und ist noch mit der Auswertung beschäftigt.
                </p>
