<?php /* Smarty version Smarty-3.0.7, created on 2017-03-08 15:48:41
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/895.cache-1.html" */ ?>
<?php /*%%SmartyHeaderCode:52006923258c019c98fd8d7-07692539%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a1f0f7f30fefc84fa597132d88bd4b19f221471f' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/895.cache-1.html',
      1 => 1488979930,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '52006923258c019c98fd8d7-07692539',
  'function' => 
  array (
  ),
...
<div class="col-xs-12">
    ...
    <div class="register-fragen">
        ...
        <div class="row">
            <div class="col-xs-12">
                <br />
                <h2 style="padding-bottom: 8px;"><?php echo smarty_function_xr_translate(array('tag'=>'Mein perfektes Zimmer'),$_smarty_tpl);?>
:</h2>
            </div>
...
*</label>
                ...
                <div class="form-group">
                    ...
                    <div class="error-div" id="v2_PASSWORT_wrong_error"><?php echo smarty_function_xr_translate(array('tag'=>"Diese Emailadresse ist bereits registriert."),$_smarty_tpl);?>
</div>
                </div>
                <div class="form-group">
...
" required/>
                ...
                <div class="geschlecht-chooser geschlecht">
                    <div class="form-group">
                        ...
                        <div class="error-div" id="GESCHLECHT_error">
                            <?php echo smarty_function_xr_translate(array('tag'=>'Bitte Geschlecht auswählen'),$_smarty_tpl);?>
    ...
    <div class="row" style="padding-top: 18px;">
        <div class="col-xs-5" style="width: 44%;">
            <button class="button start-button"><?php echo smarty_function_xr_translate(array('tag'=>'Weiter mit Facebook Login'),$_smarty_tpl);?>
</button>
        </div>
        <div class="col-xs-5" style="text-align: right; padding-right: 0px; width: 44%;">
            <button style="display:none;" class="button start-button js-simple-login"><?php echo smarty_function_xr_translate(array('tag'=>'Mit eMail adresse registrieren'),$_smarty_tpl);?>
</button>
