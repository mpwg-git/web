<?php /* Smarty version Smarty-3.0.7, created on 2017-02-10 12:17:52
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeJDh1li" */ ?>
<?php /*%%SmartyHeaderCode:750712778589da160aca029-56648822%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ddc6aa5ffd561c0dcbf2cdb25674d482b918594f' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeJDh1li',
      1 => 1486725472,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '750712778589da160aca029-56648822',
  'function' => 
  array (
  ),
...
$("#btn-mitbewohner").mouseover(function(e){
    $("img.svg.btn-icon-wgzimmer").attr('src', '/xstorage/template/redesign/svg/icon-mitbewohner-finden-turkis.svg');
...
$("#btn-mitbewohner").mouseout(function(e){
    $("img.svg.btn-icon-wgzimmer").attr('src', '/xstorage/template/redesign/svg/icon-mitbewohner-finden-black.svg');
...
$("#btn-wg").mouseover(function(e){
    $("img.svg.btn-icon-wgzimmer").attr('src', '/xstorage/template/redesign/svg/icon-wg-sucht-wg-black.svg');
...
$("#btn-wg").mouseout(function(e){
    $("img.svg.btn-icon-wgzimmer").attr('src', '/xstorage/template/redesign/svg/icon-wg-sucht-wg-turkis.svg');
