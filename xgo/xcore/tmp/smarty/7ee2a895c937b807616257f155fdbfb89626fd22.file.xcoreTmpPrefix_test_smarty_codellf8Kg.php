<?php /* Smarty version Smarty-3.0.7, created on 2016-01-13 11:01:59
         compiled from "/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codellf8Kg" */ ?>
<?php /*%%SmartyHeaderCode:169881839656962097d93f79-52630335%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ee2a895c937b807616257f155fdbfb89626fd22' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfdev.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codellf8Kg',
      1 => 1452679319,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169881839656962097d93f79-52630335',
  'function' => 
  array (
  ),
...
<div class="meinprofil-profilbild add-image add-image-profil profileimage" data-type="profile">
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['USER']['wz_TYPE']=='biete'&&$_smarty_tpl->getVariable('P_ID')->value==30){?>
        <?php if (!$_smarty_tpl->getVariable('data')->value['IMAGES']){?>
            <?php echo smarty_function_xr_atom(array('a_id'=>878,'return'=>1,'icontype'=>'frau','showFace'=>0,'desc'=>'fallback-icon'),$_smarty_tpl);?>
