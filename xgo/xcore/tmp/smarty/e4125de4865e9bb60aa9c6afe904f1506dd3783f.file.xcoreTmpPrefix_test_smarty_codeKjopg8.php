<?php /* Smarty version Smarty-3.0.7, created on 2016-08-22 16:56:55
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeKjopg8" */ ?>
<?php /*%%SmartyHeaderCode:76061682457bb12b77a0d15-58223982%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4125de4865e9bb60aa9c6afe904f1506dd3783f' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeKjopg8',
      1 => 1471877815,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '76061682457bb12b77a0d15-58223982',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                <label for="mailnotification" style="font-size: 0.8125em;margin-bottom:5px;"><?php echo smarty_function_xr_translate(array('tag'=>"Benachrichtigungen erlauben"),$_smarty_tpl);?>
</label>
                <select id="mailnotification" name="MAILNOTIFICATION" class="form-control select-helvetica">
                    <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('user')->value['wz_MAILNOTIFICATION']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value){
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
                        <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" <?php if ($_smarty_tpl->getVariable('user')->value['wz_MAILNOTIFICATION']==$_smarty_tpl->tpl_vars['v']->value['id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['label'];?>
</option>
                    <?php }} ?>
                    <option><?php echo $_smarty_tpl->getVariable('user')->value['wz_MAILNOTIFICATION'];?>
</option>
