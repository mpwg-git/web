<?php /* Smarty version Smarty-3.0.7, created on 2017-02-23 16:28:38
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeypUk51" */ ?>
<?php /*%%SmartyHeaderCode:121054356458aeffa673f4d7-67407729%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c79eeb09809050d02ab3746b8f292c566560dce3' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeypUk51',
      1 => 1487863718,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '121054356458aeffa673f4d7-67407729',
  'function' => 
  array (
  ),
        ...
        <div class="col-md-6">
            ...
            <div class="register-fragebogen">
                ...
                <div class="row">
                    ...
                    <!--<div class="col-md-1 text-center no-gutter">-->
                    <!--    <div class="toggle btn-lg btn-default off" data-toggle="toggle">-->
                    <!--        <input type="checkbox" data-toggle="toggle">-->
                    <!--        <div class="toggle-group">-->
                    <!--            <label class="btn-lg btn-primary toggle-on">On</label>-->
                    <!--            <label class="btn-lg btn-default active toggle-off">Off</label>-->
                    <!--            <span class="toggle-handle btn-lg btn-default"></span>-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</div>-->
