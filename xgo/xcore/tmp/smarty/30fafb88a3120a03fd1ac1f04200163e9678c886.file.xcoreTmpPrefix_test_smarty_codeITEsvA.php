<?php /* Smarty version Smarty-3.0.7, created on 2017-03-06 23:23:43
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeITEsvA" */ ?>
<?php /*%%SmartyHeaderCode:48650285058bde16f64bae4-80926348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '30fafb88a3120a03fd1ac1f04200163e9678c886' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeITEsvA',
      1 => 1488839023,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '48650285058bde16f64bae4-80926348',
  'function' => 
  array (
  ),
...
<div id="anmelden-inner" class="panel-collapse collapse text-left <?php if ($_smarty_tpl->getVariable('info')->value['state']==0){?>in<?php }?>">
	...
	<?php if ($_smarty_tpl->getVariable('info')->value['state']==0){?>
        <div class="errorNotification error-div">
