<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 11:00:01
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeAWBKTb" */ ?>
<?php /*%%SmartyHeaderCode:16263000085677cda18985b3-80107574%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65bb617ef734780e54939ae0c809981959291892' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeAWBKTb',
      1 => 1450692001,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16263000085677cda18985b3-80107574',
  'function' => 
  array (
  ),
...
:</span><span class="info"><?php echo $_smarty_tpl->getVariable('data')->value['ROOM']['ZEITRAUM'];?>
 ...
 m²</span>
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ADRESSE']!=''){?>
        <div id="map" class="map" style="height:20vw"></div>
        <script>
        setTimeout(function(){
            top.showOnMap = {
