<?php /* Smarty version Smarty-3.0.7, created on 2016-08-16 11:36:21
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeSs3Fnj" */ ?>
<?php /*%%SmartyHeaderCode:42444408057b2de954c2b26-21931107%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb2c4757a4ec592ea2008c6a68a60cb1568689d6' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeSs3Fnj',
      1 => 1471340181,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '42444408057b2de954c2b26-21931107',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                ...
                <label for="emailja" class="radio special-label">
                    ...
                    <span class="checked circle circle-filled" style="background: #333; color: white;"><?php echo smarty_function_xr_translate(array('tag'=>'ja'),$_smarty_tpl);?>
</span>
                    <span class="unchecked circle circle-plain" style="color: #333; border: 1px solid #333;"><?php echo smarty_function_xr_translate(array('tag'=>'ja'),$_smarty_tpl);?>
</span>
                </label>
                <label for="emailnein" class="radio special-label">
                    ...
                    <span class="checked circle circle-filled" style="background: #333; color: white;"><?php echo smarty_function_xr_translate(array('tag'=>'nein'),$_smarty_tpl);?>
</span>
                    <span class="unchecked circle circle-plain" style="color: #333; border: 1px solid #333;"><?php echo smarty_function_xr_translate(array('tag'=>'nein'),$_smarty_tpl);?>
</span>
                </label>
            </div>      
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                <label style="font-size: 14px;"><?php echo smarty_function_xr_translate(array('tag'=>"Sprachen?"),$_smarty_tpl);?>
</label>
                <div class="v-center multiple-select-container">
                    <select class="form-control multiple-select" name="SPRACHEN[]" multiple="multiple" style="color: #333;">
