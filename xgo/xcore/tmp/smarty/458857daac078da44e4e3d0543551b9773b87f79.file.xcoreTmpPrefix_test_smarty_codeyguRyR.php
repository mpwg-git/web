<?php /* Smarty version Smarty-3.0.7, created on 2016-08-12 16:45:51
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeyguRyR" */ ?>
<?php /*%%SmartyHeaderCode:195783215257ade11fda10e7-69936261%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '458857daac078da44e4e3d0543551b9773b87f79' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeyguRyR',
      1 => 1471013151,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '195783215257ade11fda10e7-69936261',
  'function' => 
  array (
  ),
...
" class="form-control" />
            ...
            <div class="form-group">
                <label for="emailnotification">Benachrichtigung</label>
                <input id="emailnotification" name="EMAILNOTIFICATION" value="<?php echo $_smarty_tpl->getVariable('user')->value['wz_EMAILNOTIFICATION'];?>
" class="form-control" />
            </div>            
            <div class="form-group">
                <label for="emailnotification">Benachrichtigung</label>
