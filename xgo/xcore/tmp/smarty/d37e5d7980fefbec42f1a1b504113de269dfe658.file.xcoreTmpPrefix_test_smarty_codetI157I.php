<?php /* Smarty version Smarty-3.0.7, created on 2015-10-08 12:32:48
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codetI157I" */ ?>
<?php /*%%SmartyHeaderCode:166508476856164650ed5fa8-25660248%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd37e5d7980fefbec42f1a1b504113de269dfe658' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codetI157I',
      1 => 1444300368,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '166508476856164650ed5fa8-25660248',
  'function' => 
  array (
  ),
    ...
    <div class="col-xs-6">
        <div class="frage-du frage-ichwuensche">
            ...
            <ul class="option-container js-options-suche">
                <li class="option" data-id="13">a</li>
                <li class="option" data-id="14">b</li>
                                    <li class="option" data-id="15">c</li>    
                            </ul>
