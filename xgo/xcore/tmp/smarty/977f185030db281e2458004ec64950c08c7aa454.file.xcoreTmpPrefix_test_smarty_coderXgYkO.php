<?php /* Smarty version Smarty-3.0.7, created on 2017-02-20 10:03:15
         compiled from "/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_coderXgYkO" */ ?>
<?php /*%%SmartyHeaderCode:87328264258aab0d32cf644-37631565%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '977f185030db281e2458004ec64950c08c7aa454' => 
    array (
      0 => '/srv/gitgo_daten/www/wsfbeta.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_coderXgYkO',
      1 => 1487581395,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '87328264258aab0d32cf644-37631565',
  'function' => 
  array (
  ),
...
<div id="anmelden-inner" class="panel-collapse collapse text-left">
	...
	<form role="form" action="/de/anmelden" id="form-login" method="post">
		...
		<div class="form-group">
			<label for="passwort" class="text-uppercase">Passwort</label> <input id="wz_PASSWORT" name="wz_PASSWORT" type="password" class="form-control" rel="required">
