<?php /* Smarty version Smarty-3.0.7, created on 2015-12-21 11:46:44
         compiled from "/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4vsmsv" */ ?>
<?php /*%%SmartyHeaderCode:11517859385677d89405b266-09030455%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b07f2c20b497b43fb7e7d6da20fe75180d8d3799' => 
    array (
      0 => '/srv/gitgo_daten/www/wsf.xgodev.com/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4vsmsv',
      1 => 1450694804,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11517859385677d89405b266-09030455',
  'function' => 
  array (
  ),
...
<br><?php echo smarty_function_xr_translate(array('tag'=>"/Veganer"),$_smarty_tpl);?>
    ...
    <?php if ($_smarty_tpl->getVariable('data')->value['ROOM']['wz_ADRESSE']!=''){?>
        <div id="map" class="map2" style="height:40vw"></div>
        <script>
        setTimeout(function(){
            top.showOnMap = {
