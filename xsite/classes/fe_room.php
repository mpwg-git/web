...
class fe_room
{
	...
	public static function send_kaltaquise_mail_by_roomId_and_email($roomId, $email)
	{
		...
		if ($tmpUserData['EXISTS'] === true) {
			$replacers['###PASSWORT###'] = xredaktor_translate::doTranslate('Bitte benutze dein eingestelltes Passwort.', xredaktor_pages::getFrontEndLang(), 1);
		} else {
