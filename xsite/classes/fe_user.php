...
class fe_user
{
	...
	public static function deactivate_user_account($userId)
	{
		...
		// UPDATE USER wz
		dbx::update("wizard_auto_707", array('wz_USERDEL' => 'Y', 'wz_USERDEL_TS' => 'NOW()', 'wz_ACTIVE' => 'N', 'wz_del' => 'Y'), array('wz_id' => $userId));
	...
	*/
	...
	public static function getUserData($userId)
	{
		...
		$mailnotif 	= dbx::query("select wz_EMAILBENACHRICHTIGUNG from wizard_auto_707 where wz_id = $userId");
