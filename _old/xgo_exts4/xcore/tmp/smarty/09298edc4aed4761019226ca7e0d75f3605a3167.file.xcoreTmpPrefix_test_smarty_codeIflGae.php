<?php /* Smarty version Smarty-3.0.7, created on 2015-02-02 15:17:35
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeIflGae" */ ?>
<?php /*%%SmartyHeaderCode:151566180454cf86ffd30826-92432680%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09298edc4aed4761019226ca7e0d75f3605a3167' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeIflGae',
      1 => 1422886655,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151566180454cf86ffd30826-92432680',
  'function' => 
  array (
  ),
...
"/>
        ...
        <meta property="og:image" content="<?php echo $_smarty_tpl->getVariable('ogimage')->value['url'];?>
"/>
        <?php }?>
...
"/>
		...
		<?php echo smarty_function_xr_siteCall(array('fn'=>'oa_validation::showAds','var'=>'showAdsContainer'),$_smarty_tpl);?>

		
		
		<?php if ($_REQUEST['debugads']==1){?>
		    <?php echo smarty_function_xr_print_r(array('var'=>'showAdsContainer'),$_smarty_tpl);?>

		<?php }?>
		
        <?php if (((($_smarty_tpl->getVariable('P_ID')->value==29||$_smarty_tpl->getVariable('P_ID')->value==74||$_smarty_tpl->getVariable('P_ID')->value==75||$_smarty_tpl->getVariable('P_ID')->value==76||$_smarty_tpl->getVariable('P_ID')->value==122||$_smarty_tpl->getVariable('P_ID')->value==123||$_smarty_tpl->getVariable('P_ID')->value==125||$_smarty_tpl->getVariable('P_ID')->value==60||$_smarty_tpl->getVariable('P_ID')->value==61||$_smarty_tpl->getVariable('P_ID')->value==62||$_smarty_tpl->getVariable('P_ID')->value==63||$_smarty_tpl->getVariable('P_ID')->value==64||$_smarty_tpl->getVariable('P_ID')->value==65||$_smarty_tpl->getVariable('P_ID')->value==28||$_smarty_tpl->getVariable('P_ID')->value==7||$_smarty_tpl->getVariable('P_ID')->value==9||$_smarty_tpl->getVariable('P_ID')->value==10||$_smarty_tpl->getVariable('P_ID')->value==11)&&$_smarty_tpl->getVariable('showAdsContainer')->value)||$_REQUEST['showads']==1)){?>
		<link rel="stylesheet" type="text/css" href="//lz-cdn-r.xgodev.com/archive/template/css/addview.css" />
		<?php }?>
		...
		<style type="text/css">
            ...
            @font-face {
              font-family: 'VideoJS';
              src: url('/archive/template/css/font/vjs.eot');
              src: url('/archive/template/css/font/vjs.eot?#iefix') format('embedded-opentype'), url('/archive/template/css/font/vjs.woff') format('woff'), url('/archive/template/css/font/vjs.ttf') format('truetype');
              font-weight: normal;
              font-style: normal;
            }
...
';
	...
	<script>
      ...
      ga('create', 'UA-51135574-1', 'auto');
      ga('require', 'displayfeatures');
      ga('send', 'pageview');
      
      
      if ('<?php echo $_smarty_tpl->getVariable('P_ID')->value;?>
' == '1')
      {
          ga('send', 'event', 'ERROR_404', document.referrer, document.location.pathname + document.location.search,  1);
...
<?php if (((($_smarty_tpl->getVariable('P_ID')->value==29||$_smarty_tpl->getVariable('P_ID')->value==74||$_smarty_tpl->getVariable('P_ID')->value==75||$_smarty_tpl->getVariable('P_ID')->value==76||$_smarty_tpl->getVariable('P_ID')->value==122||$_smarty_tpl->getVariable('P_ID')->value==123||$_smarty_tpl->getVariable('P_ID')->value==125||$_smarty_tpl->getVariable('P_ID')->value==60||$_smarty_tpl->getVariable('P_ID')->value==61||$_smarty_tpl->getVariable('P_ID')->value==62||$_smarty_tpl->getVariable('P_ID')->value==63||$_smarty_tpl->getVariable('P_ID')->value==64||$_smarty_tpl->getVariable('P_ID')->value==65||$_smarty_tpl->getVariable('P_ID')->value==28||$_smarty_tpl->getVariable('P_ID')->value==7||$_smarty_tpl->getVariable('P_ID')->value==9||$_smarty_tpl->getVariable('P_ID')->value==10||$_smarty_tpl->getVariable('P_ID')->value==11)&&$_smarty_tpl->getVariable('showAdsContainer')->value))){?>
