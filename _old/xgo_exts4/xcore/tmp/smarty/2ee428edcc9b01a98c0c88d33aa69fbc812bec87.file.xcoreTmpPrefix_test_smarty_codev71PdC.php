<?php /* Smarty version Smarty-3.0.7, created on 2014-10-09 14:09:29
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codev71PdC" */ ?>
<?php /*%%SmartyHeaderCode:113322637954369719eaca60-41520794%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ee428edcc9b01a98c0c88d33aa69fbc812bec87' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codev71PdC',
      1 => 1412863769,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '113322637954369719eaca60-41520794',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_submissions_edit::get_submission_credits','var'=>'credits'),$_smarty_tpl);?>


<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_submissions_edit::get_valid_credits','var'=>'validcredits'),$_smarty_tpl);?>


<?php if ($_REQUEST['debug']==1){?><?php echo smarty_function_xr_print_r(array('val'=>$_smarty_tpl->getVariable('credits')->value),$_smarty_tpl);?>
<?php }?>
...
">
                        	<div class="col-sm-4 static-uploaded-images">
                        		...
                        		<?php if ($_smarty_tpl->getVariable('data')->value['es_image_highRes_s_id']==0){?>
                        		<?php echo smarty_function_xr_img(array('s_id'=>$_smarty_tpl->getVariable('data')->value['es_image_s_id'],'w'=>400,'var'=>'image'),$_smarty_tpl);?>

                        		<?php }else{ ?>
                        		<?php echo smarty_function_xr_img(array('s_id'=>$_smarty_tpl->getVariable('data')->value['es_image_highRes_s_id'],'w'=>400,'var'=>'image'),$_smarty_tpl);?>

                        		<?php }?>
                        		<img src="<?php echo $_smarty_tpl->getVariable('image')->value['src'];?>
" class="img-responsive" alt="" id="preview-image-<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
" />
...
" style="color: green;">PRESENT</span><?php }?>
                        			<form enctype="multipart/form-data" method="POST" action="/xsite/call/fe_submissions_edit/upload_print_highres" id="fileupload_<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
">
                        			<input type="hidden" name="SUBMISSIONTYPE" value="PRINT" />
                        			
                        			<span class="btn btn-default fileinput-button" id="uploadHighres_<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
">
...
" class="form-control inputCampaign highlight-on-error validate[required]" value="<?php echo $_smarty_tpl->getVariable('data')->value['es_campaign'];?>
" data-id="<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
" />
                        		</div>
...
" class="form-control inputAdTitle" value="<?php echo $_smarty_tpl->getVariable('data')->value['es_ad_title'];?>
" data-id="<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
" />
                        		</div>
                        		...
                        		<div class="form-group">
                        					...
                        					<textarea class="form-control inputExplanation height200" name="Explanation" id="Explanation_<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
"><?php echo $_smarty_tpl->getVariable('data')->value['es_notes'];?>
                        		...
                        		<div class="form-group">
                        					...
                        					<input type="text" class="form-control inputRelease highlight-on-error validate[required]" name="Release" id="Release_<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
...
" />
                        		...
                        		<div class="form-group">
                        				...
                        				<input type="text" class="form-control inputKeywords" name="Keywords" id="Keywords_<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
...
">Back</a> <a id="submit-edit" class="but button-large" href="<?php echo smarty_function_xr_genlink(array('p_id'=>115),$_smarty_tpl);?>
" data-id="<?php echo $_smarty_tpl->getVariable('data')->value['es_id'];?>
">Next</a>
    </div>
</div>
