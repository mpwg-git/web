<?php /* Smarty version Smarty-3.0.7, created on 2014-10-30 18:14:39
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7k8eZs" */ ?>
<?php /*%%SmartyHeaderCode:11700209595452800f60c863-83841104%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcf2c11a1d2e71570efae202b5b9900950fd7d61' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code7k8eZs',
      1 => 1414692879,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11700209595452800f60c863-83841104',
  'function' => 
  array (
  ),
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="checkbox" value=""<?php if ($_smarty_tpl->getVariable('data')->value['publish_FIRSTNAME']==1||$_smarty_tpl->getVariable('data')->value['TYPE']==1){?> checked="checked" disabled<?php }?> id="fep_publishFirstname" class="publish-in-profile" data-toggle="tooltip" title="Publish in Profile">
...
" id="inputFNAME" class="form-control required" name="fep_firstname">
					...
					<div class="col-sm-6">  
						<div class="form-group">
							...
							<input type="checkbox" value=""<?php if ($_smarty_tpl->getVariable('data')->value['publish_LASTNAME']==1||$_smarty_tpl->getVariable('data')->value['TYPE']==1){?> checked="checked" disabled<?php }?> id="fep_publishLastname" class="publish-in-profile" data-toggle="tooltip" title="Publish in Profile">
