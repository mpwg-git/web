<?php /* Smarty version Smarty-3.0.7, created on 2015-01-05 22:12:33
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/564.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:142706701154aafe4128a556-38905065%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bed0cca990364129af7bedb378bce1ce0c884e3f' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/564.cache.html',
      1 => 1420468741,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '142706701154aafe4128a556-38905065',
  'function' => 
  array (
  ),
...
" style="color: green;">PRESENT</span><?php }?>
			<form enctype="multipart/form-data" method="POST" action="/xsite/call/fe_submissions/upload_students_highres" id="fileupload_<?php echo $_smarty_tpl->getVariable('data')->value['estd_id'];?>
">
...
">x</button> 
		    ...
		    <div class="row">
				<div class="col-sm-12 marginTop20 marginBottom20">
        			...
        			<a href="" class="but button-large next-in-students-submission" id="next-in-submission_<?php echo $_smarty_tpl->getVariable('data')->value['estd_id'];?>
" data-id="<?php echo $_smarty_tpl->getVariable('data')->value['estd_id'];?>
">confirm</a>
                    </div>
                </div>
