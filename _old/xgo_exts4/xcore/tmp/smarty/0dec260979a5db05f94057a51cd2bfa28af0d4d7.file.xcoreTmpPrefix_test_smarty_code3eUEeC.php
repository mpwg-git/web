<?php /* Smarty version Smarty-3.0.7, created on 2014-08-23 17:29:31
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code3eUEeC" */ ?>
<?php /*%%SmartyHeaderCode:104274758353f8b35bd95940-91787970%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0dec260979a5db05f94057a51cd2bfa28af0d4d7' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code3eUEeC',
      1 => 1408807771,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '104274758353f8b35bd95940-91787970',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_profiles::sc_get_my_beyond_archive','var'=>'beyond'),$_smarty_tpl);?>
	...
	<div class="row my-profile">
		...
		<div class="col-sm-4">
			...
			<h2 class="linieBottom myproH2"><?php if ($_smarty_tpl->getVariable('data')->value['FIRSTNAMcE']!=''&&$_smarty_tpl->getVariable('data')->value['TYPE']!='0'){?><?php echo $_smarty_tpl->getVariable('data')->value['FIRSTNAME'];?>
...
, <?php }?><?php if ($_smarty_tpl->getVariable('data')->value['CITY']!=''){?><?php echo $_smarty_tpl->getVariable('data')->value['CITY'];?>
 - <?php }?><?php if ($_smarty_tpl->getVariable('data')->value['COUNTRY']!='International'){?><?php echo $_smarty_tpl->getVariable('data')->value['COUNTRY'];?>
<?php }?>
			</strong></p>
