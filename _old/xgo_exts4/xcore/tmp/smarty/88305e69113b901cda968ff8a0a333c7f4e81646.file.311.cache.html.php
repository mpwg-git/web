<?php /* Smarty version Smarty-3.0.7, created on 2015-02-24 15:47:41
         compiled from "/srv/gitgo_daten/www/shop.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/311.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:90058724554ec8f0d872733-31563802%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '88305e69113b901cda968ff8a0a333c7f4e81646' => 
    array (
      0 => '/srv/gitgo_daten/www/shop.xgodev.com/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/311.cache.html',
      1 => 1424789261,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '90058724554ec8f0d872733-31563802',
  'function' => 
  array (
  ),
...
<div class="menuMobileWrapper hidden-lg">
    <div class="menuMobile">
        <ul class="nav navbar-nav nav-main jquerydyn">
...
"
                        target="_self"
                        class="dropdown-toggle hauptmenuepunkt <?php if ($_smarty_tpl->getVariable('active')->value==true){?>aktiv<?php }?><?php if ($_smarty_tpl->tpl_vars['p']->value['busTyp']!=''){?> hasSub<?php }?>"
                        <?php if ($_smarty_tpl->tpl_vars['p']->value['busTyp']!=''){?>
                            data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"
                        <?php }?>>
                        <span><?php echo $_smarty_tpl->tpl_vars['p']->value['name'];?>
</span>
                        <?php if ($_smarty_tpl->tpl_vars['p']->value['busTyp']!=''){?><span class="triangle"></span><?php }?>
