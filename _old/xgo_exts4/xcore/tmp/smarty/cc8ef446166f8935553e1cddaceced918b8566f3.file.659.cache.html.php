<?php /* Smarty version Smarty-3.0.7, created on 2015-02-02 16:51:11
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/659.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:20033618654cf9cefb03799-13744707%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc8ef446166f8935553e1cddaceced918b8566f3' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/659.cache.html',
      1 => 1422892270,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20033618654cf9cefb03799-13744707',
  'function' => 
  array (
  ),
...
"<?php if ((count($_smarty_tpl->getVariable('dropdowns')->value['weeks'])-$_smarty_tpl->tpl_vars['k']->value)==$_smarty_tpl->getVariable('dropdowns')->value['feature_week']){?> selected="selected"<?php }?>>Week <?php echo count($_smarty_tpl->getVariable('dropdowns')->value['weeks'])-$_smarty_tpl->tpl_vars['k']->value;?>
		...
		<ul class="nav nav-pills p-woche nav-slider features">
			<li class="fix-tabs0 active" id="features-slider-tab--1"><a href="" class="features-slider-tabs features-slider-tabs2" data-id="-1">LATEST</a></li>
        ...
        $( document ).ready(function() {
            ...
            $('.features-slider-tabs2').click(function(){
                ...
                var url="/en/features.html?NCNOW&r_id="+(parseInt($(this).data('id'),10)+1);
