<?php /* Smarty version Smarty-3.0.7, created on 2014-10-16 14:18:06
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/557.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:2079195869543fd39e9d3e70-53015916%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '835a4134550caab6f03b2a9b81d7458d14b9d1d7' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/557.cache.html',
      1 => 1413469084,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2079195869543fd39e9d3e70-53015916',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_submissions::get_already_uploaded_work','SUBMISSIONTYPE'=>'STUDENTS','var'=>'html'),$_smarty_tpl);?>
...
" />
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<div class="row">
					<div class="col-sm-12">
					   <p><?php echo smarty_function_xr_imgWrapper(array('s_id'=>1180980,'ext'=>'png','w'=>1137,'class'=>"img-responsive"),$_smarty_tpl);?>
</p>
					</div>
					<div class="col-sm-12">
					    <div class="row">
					        ...
					        <div class="col-sm-6">
					            <div style="border: 2px solid #737371; margin-top: 2px;">
					                ...
					                <div style="float: left; padding-bottom: 10px;">
        				            	<form id="fileupload" action="/xsite/call/fe_submissions/upload_students" method="POST" enctype="multipart/form-data">
...
<div class="row">
    ...
    <a class="but button-large" href="<?php echo smarty_function_xr_genlink(array('p_id'=>98),$_smarty_tpl);?>
">Back</a> <a id="submit-students" class="but button-large <?php if ($_smarty_tpl->getVariable('html')->value==''){?>disable-submission-send<?php }?>" href="<?php echo smarty_function_xr_genlink(array('p_id'=>102),$_smarty_tpl);?>
">Next</a>
    </div>
</div>
