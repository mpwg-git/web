<?php /* Smarty version Smarty-3.0.7, created on 2014-10-16 12:08:30
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeD006ZO" */ ?>
<?php /*%%SmartyHeaderCode:204659926543fb53e5ab3b5-57985538%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b44f4cbc5ced031c9d6cb17800cbfe97e5426575' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeD006ZO',
      1 => 1413461310,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '204659926543fb53e5ab3b5-57985538',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_ads::sc_get_ad','var'=>'ad'),$_smarty_tpl);?>
 ...
 <?php echo smarty_function_xr_siteCall(array('fn'=>'fe_thisweek::sc_get_dropdowns_insp','var'=>'dropdowns'),$_smarty_tpl);?>
...
<?php echo smarty_function_xr_print_r(array('val'=>$_smarty_tpl->getVariable('dropdowns')->value),$_smarty_tpl);?>
...
<?php }?>
	...
	<div class="row">
	    ...
	    <div class="col-sm-9">
			...
			<h1>Inspiration</h1>
			<div class="form-group floatLeft" style="">
...
"<?php if ($_smarty_tpl->tpl_vars['v']->value['esotw__year']==$_smarty_tpl->getVariable('dropdowns')->value['feature_year']){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['esotw_year'];?>
</option>
				    <?php }} ?>
				</select>
...
"><?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->getVariable('yourpick')->value['IMG'],'w'=>444,'rmode'=>'cco','class'=>"img-responsive"),$_smarty_tpl);?>
</a>
    					</div>
    				</div>
