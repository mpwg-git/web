<?php /* Smarty version Smarty-3.0.7, created on 2014-10-16 14:26:44
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/533.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:2127971134543fd5a43e4b06-70156152%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19904e31dc8077e3718cf2794e4963d846dc0bde' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/533.cache.html',
      1 => 1413469550,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2127971134543fd5a43e4b06-70156152',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_submissions::get_already_uploaded_work','SUBMISSIONTYPE'=>'VIDEO','var'=>'html'),$_smarty_tpl);?>
...
" />
	...
	<div class="row">
		<div class="col-sm-9">
		    ...
		    <h1>Submit Your Work - TV Commercials</h1>
	...
	<div class="row">
			<div class="col-sm-12">
				...
				<div class="row">
					<div class="col-sm-12">
					   <p><?php echo smarty_function_xr_imgWrapper(array('s_id'=>1180979,'ext'=>'png','w'=>1137,'class'=>"img-responsive"),$_smarty_tpl);?>
</p>
					</div>
					<div class="col-sm-12">
					    <div class="row">
					        ...
					        <div class="col-sm-6">
					            <div style="border: 2px solid #737371; margin-top: 2px;">
					                ...
					                <div style="float: left; padding-bottom: 10px;">
        				            	<form id="fileupload" action="/xsite/call/fe_submissions/upload_video" method="POST" enctype="multipart/form-data">
                        				<div class="upload-area" style="padding-top: 30px;">
                        				    <span id="uploadFilesVideo" class=" btn btn-default fileinput-button fileinput-button-main">
...
<div class="row">
    ...
    <a class="but button-large" href="<?php echo smarty_function_xr_genlink(array('p_id'=>91),$_smarty_tpl);?>
">Back</a> <a id="submit-tv-commercial" class="but button-large <?php if ($_smarty_tpl->getVariable('html')->value==''){?>disable-submission-send<?php }?>" href="<?php echo smarty_function_xr_genlink(array('p_id'=>92),$_smarty_tpl);?>
">Next</a>
    </div>
</div>
