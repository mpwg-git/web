<?php /* Smarty version Smarty-3.0.7, created on 2014-08-12 16:05:17
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4rir1C" */ ?>
<?php /*%%SmartyHeaderCode:2385898353ea1f1de989e1-65054862%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ecb92dbe9df3feb04b6baf8bb8ea917b01c51683' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code4rir1C',
      1 => 1407852317,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2385898353ea1f1de989e1-65054862',
  'function' => 
  array (
  ),
...
?><?php echo smarty_function_xr_siteCall(array('fn'=>'fe_adsoftheweek::sc_get_dropdowns','type'=>'classic_spot','var'=>'dropdowns'),$_smarty_tpl);?>

<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_adsoftheweek::sc_get_this_week','type'=>'classic_spot','var'=>'data'),$_smarty_tpl);?>

<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_likes::sc_do_i_like_it','record_type'=>"MEDIA",'record_id'=>$_smarty_tpl->getVariable('data')->value['CLASSIC']['SID'],'var'=>'likeit'),$_smarty_tpl);?>

<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_favs::sc_do_i_fav_it','record_type'=>"MEDIA",'record_id'=>$_smarty_tpl->getVariable('data')->value['CLASSIC']['SID'],'var'=>'favit'),$_smarty_tpl);?>
	...
	<div class="row">
		<div class="col-sm-9">
    		...
    		<form class="issue-suche">
    			<h1>Classic Spot of the Week</h1>
    			<div class="form-group">
    				<select class="form-control sel" id="ads-of-week-year-filter-classic_spot">
...
" class="adsoftheweekbutton active">Classic Spot</a></div></div> 
		</div>
				...
				<div>
    			    <div class="row">
                        	...
                        	<div class="col-sm-8 videoplayer">
                        	    <?php if ($_smarty_tpl->getVariable('data')->value['CLASSIC']['VID']['es_video_480_mp4_s_id']){?>
                        	    <!-- video BEGIN -->
                    		    ...
                    		    <?php echo smarty_function_xr_file(array('s_id'=>$_smarty_tpl->getVariable('data')->value['CLASSIC']['VID']['es_video_480_mp4_s_id'],'var'=>'mp4'),$_smarty_tpl);?>
...
" type='video/webm' />
                                ...
                                <div class="videolength">
                                    <?php echo $_smarty_tpl->getVariable('data')->value['CLASSIC']['VIDLENGTH'];?>
                                ...
                                <div class="thumbs">
                                  ...
                                  <script>
                        			...
                        			var video2 = videojs('video2', {"nativeControlsForTouch": true, "customControlsOnMobile": true});
                        			
                        			video2.posterImage.show(); 
                        			
                        			video2.on("ended", function(){ 
                        			    console.log("video end");
                        			    video2.poster('/archive_template/img/placeholder_video.jpg');
...
'
            ...
            <!-- 
            <div class="picbottommetalinks"><p class="lw-item workdetailpicbottom"><a href="#" class="like<?php if ($_smarty_tpl->getVariable('likeit')->value==1){?> active<?php }?> ilikeit" title="Gefällt mir" data-id=<?php echo $_smarty_tpl->getVariable('data')->value['CLASSIC']['SID'];?>
 data-type="MEDIA"></a></span> <span class="likeCount"><?php echo $_smarty_tpl->getVariable('data')->value['CLASSIC']['LIKES'];?>
</span> <a class="but favorites ifavit<?php if ($_smarty_tpl->getVariable('favit')->value==1){?> active<?php }?>" href="#" data-id=<?php echo $_smarty_tpl->getVariable('data')->value['CLASSIC']['SID'];?>
 data-type="MEDIA">Add to favorites</a></p></div>->
            <br />
            -->
                        	    <!-- video END -->
                        <div class="picbottommetalinks"><p class="lw-item workdetailpicbottom"><a href="#" class="like<?php if ($_smarty_tpl->getVariable('likeit')->value==1){?> active<?php }?> ilikeit" title="Gefällt mir" data-id=<?php echo $_smarty_tpl->getVariable('data')->value['CLASSIC']['MEDIAID'];?>
 data-type="<?php echo $_smarty_tpl->getVariable('data')->value['CLASSIC']['TYPE'];?>
"></a></span> <span class="likeCount"><?php echo $_smarty_tpl->getVariable('data')->value['CLASSIC']['LIKES'];?>
</span> </p></div>
            <br />	
            				</div>
