<?php /* Smarty version Smarty-3.0.7, created on 2014-12-10 10:03:08
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/519.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:187669259054881a5c8b9513-12202099%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f3ae2ae2f26e5efec89be395717b03f67d17659f' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/519.cache.html',
      1 => 1418205787,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '187669259054881a5c8b9513-12202099',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'oe_preview::sc_get_app','var'=>'data'),$_smarty_tpl);?>

<?php }else{ ?>
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_magazine::sc_get_media_details','in_json_gallery'=>'eda_img_gallery','w'=>690,'var'=>'data'),$_smarty_tpl);?>
    ...
    <div class="row">
		<div class="col-sm-6">
    		...
    		<div id="content-slider-1" class="royalSlider contentSlider rsDefault">
    		    ...
    		    <div>
        		    <?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->getVariable('data')->value['IMG'],'w'=>539,'showgififgif'=>1,'class'=>"img-responsive rsImg rsMainSlideImage"),$_smarty_tpl);?>
</a></p>
...
?>
    		    <div>
        		    <?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->tpl_vars['v']->value['IMG'],'w'=>539,'showgififgif'=>1,'class'=>"img-responsive rsImg rsMainSlideImage"),$_smarty_tpl);?>
</a></p>
        		    <span class="rsTmb"><?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['count']['index']+2;?>
</span>
    		    </div>
    		<?php }} ?>
		...
		<div class="col-sm-6">
		    ...
		    <div class="workdetailmetainfo">
		        <?php if ($_smarty_tpl->getVariable('data')->value['JSON']['eda_link1']!=''){?><p><span class="workdetailmetatitle">Link:</span> <a href="http://<?php echo $_smarty_tpl->getVariable('data')->value['JSON']['eda_link1'];?>
" target="_blank"><?php echo $_smarty_tpl->getVariable('data')->value['JSON']['eda_linkText1'];?>
</a></p><?php }?>
		        <?php if ($_smarty_tpl->getVariable('data')->value['JSON']['eda_link2']!=''){?><p><span class="workdetailmetatitle">Link:</span> <a href="http://<?php echo $_smarty_tpl->getVariable('data')->value['JSON']['eda_link2'];?>
" target="_blank"><?php echo $_smarty_tpl->getVariable('data')->value['JSON']['eda_linkText2'];?>
</a></p><?php }?>
