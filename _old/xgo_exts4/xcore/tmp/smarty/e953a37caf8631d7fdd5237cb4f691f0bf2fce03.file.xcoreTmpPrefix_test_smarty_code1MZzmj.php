<?php /* Smarty version Smarty-3.0.7, created on 2014-08-13 21:24:46
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1MZzmj" */ ?>
<?php /*%%SmartyHeaderCode:59098150453ebbb7e812af2-80843104%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e953a37caf8631d7fdd5237cb4f691f0bf2fce03' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code1MZzmj',
      1 => 1407957886,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '59098150453ebbb7e812af2-80843104',
  'function' => 
  array (
  ),
...
" target="_blank">
    ...
    <td>
        <table>
            <tr>
                <td colspan="2" style="font-size: 14px; font-weight: bold;"><?php echo $_smarty_tpl->tpl_vars['v']->value['es_campaign'];?>
</td>
            </tr>
            <tr>
                <td valign="top"><?php echo smarty_function_xr_imgWrapper(array('s_id'=>270400,'w'=>39,'ext'=>'png','cloud'=>0),$_smarty_tpl);?>
</td>
                <td valign="top" style="font-size: 14px;"><?php echo $_smarty_tpl->getVariable('credits')->value['clients'];?>
</td>
            </tr>
            <tr>
                <td valign="top"><?php echo smarty_function_xr_imgWrapper(array('s_id'=>270363,'w'=>39,'ext'=>'png','cloud'=>0),$_smarty_tpl);?>
</td>
                <td valign="top" style="font-size: 14px;"><?php echo $_smarty_tpl->getVariable('credits')->value['agencies'];?>
</td>
            </tr>
        </table>
    </td>
