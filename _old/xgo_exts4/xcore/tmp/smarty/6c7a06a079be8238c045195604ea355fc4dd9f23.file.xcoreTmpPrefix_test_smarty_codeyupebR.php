<?php /* Smarty version Smarty-3.0.7, created on 2014-10-31 09:34:56
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeyupebR" */ ?>
<?php /*%%SmartyHeaderCode:1916477230545357c0ce19b5-68139953%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6c7a06a079be8238c045195604ea355fc4dd9f23' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeyupebR',
      1 => 1414748096,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1916477230545357c0ce19b5-68139953',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_function_xr_print_r')) include '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/function.xr_print_r.php';
...
<div>
 ...
 <?php if ($_REQUEST['debug']==1){?>
            <pre>count: <?php echo smarty_function_xr_print_r(array('val'=>$_smarty_tpl->getVariable('records')->value['pager']['cnt']),$_smarty_tpl);?>
</pre>
            <pre>results <?php echo smarty_function_xr_print_r(array('val'=>$_smarty_tpl->getVariable('records')->value['records']),$_smarty_tpl);?>
</pre>
        <?php }?> 
...
<?php if ($_smarty_tpl->getVariable('records')->value['pager']['cnt']==0){?>
NO RECORDS FOUND.
...
">
        	...
        	<?php $_smarty_tpl->tpl_vars['pos'] = new Smarty_variable(intval($_smarty_tpl->getVariable('records')->value['pager']['start'])+$_smarty_tpl->tpl_vars['k']->value, null, null);?>
        		...
        		<h3><?php if (($_smarty_tpl->tpl_vars['v']->value['fep_type']==0&&$_smarty_tpl->tpl_vars['v']->value['fep_company']!='')){?>
        		<span class="type <?php echo $_smarty_tpl->tpl_vars['v']->value['fep_type'];?>
"></span><?php echo $_smarty_tpl->tpl_vars['v']->value['fep_company'];?>
