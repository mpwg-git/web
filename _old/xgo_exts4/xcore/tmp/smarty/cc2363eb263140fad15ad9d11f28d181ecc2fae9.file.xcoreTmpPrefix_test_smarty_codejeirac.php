<?php /* Smarty version Smarty-3.0.7, created on 2014-07-25 09:25:35
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejeirac" */ ?>
<?php /*%%SmartyHeaderCode:185140986953d2066f91fe43-55583105%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc2363eb263140fad15ad9d11f28d181ecc2fae9' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codejeirac',
      1 => 1406273135,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '185140986953d2066f91fe43-55583105',
  'function' => 
  array (
  ),
...
?>
        <div class="row">
    		<div class="col-sm-12">
    			...
    			<ul class="nav nav-pills p-woche">
    			    <?php if (isset($_smarty_tpl->getVariable('REQUEST',null,true,false)->value['tab'])){?>
    			    <?php if ((strpos($_smarty_tpl->getVariable('am')->value['print'],'col-sm-4'))){?><li class="mytabs"><a data-toggle="tab" class="magazinetabslinks" href="#tab-print">Print</a></li><?php }?>
    				<?php if ((strpos($_smarty_tpl->getVariable('am')->value['commercials'],'col-sm-4'))){?><li class="<?php if ($_smarty_tpl->getVariable('REQUEST')->value['tab']=='film'){?>active <?php }?>mytabs"><a data-toggle="tab" class="magazinetabslinks" href="#tab-commercials">Film</a></li><?php }?>
    				<?php if ((strpos($_smarty_tpl->getVariable('am')->value['digital'],'col-sm-4'))){?><li class="<?php if ($_smarty_tpl->getVariable('REQUEST')->value['tab']=='digital'){?>active <?php }?>mytabs"><a data-toggle="tab" class="magazinetabslinks" href="#tab-digital">Digital</a></li><?php }?>
    			    <?php }else{ ?>
    				...
    				<?php if ((strpos($_smarty_tpl->getVariable('am')->value['commercials'],'col-sm-4'))){?><li class="mytabs"><a data-toggle="tab" class="magazinetabslinks" href="#tab-commercials">Film</a></li><?php }?>
    ...
    <!-- commercials begin -->	
    		<div id="tab-commercials" class="tab-pane">
                <div class="row lw-item">
                    <div class="col-sm-12">
