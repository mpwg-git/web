<?php /* Smarty version Smarty-3.0.7, created on 2014-10-07 16:21:18
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/636.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:120634650543412fe696d74-52911806%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '90bca09b418b6ed0c49080556c09c591f36b51c5' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/636.cache.html',
      1 => 1412160001,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '120634650543412fe696d74-52911806',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_submissions_edit::get_submission_students_by_id','var'=>'data'),$_smarty_tpl);?>

<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_submissions_edit::sc_get_countries','var'=>'countries'),$_smarty_tpl);?>

<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_submissions_edit::get_contact_data','var'=>'contact'),$_smarty_tpl);?>
...
"<?php if ($_smarty_tpl->getVariable('data')->value['COUNTRY_ID']==$_smarty_tpl->tpl_vars['v']->value['asc_id']){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['asc_name'];?>
</option>
								<?php }} ?>
							</select>
						</div>
...
" placeholder="Enter Email" id="TEACHEREMAIL" class="form-control">
    						</div>
    					</div>
    				</div>
				</div>
...
" placeholder="Enter Email" id="exampleInputEMAIL2" class="form-control">
				...
				<div class="row">
				    ...
				    <a class="but button-large" href="<?php echo smarty_function_xr_genlink(array('p_id'=>41),$_smarty_tpl);?>
">Back</a> <a class="but button-large" href="<?php echo smarty_function_xr_genlink(array('p_id'=>142),$_smarty_tpl);?>
" id="submit-contact-data-students-edit">Next</a>
			        </div>
				</div>
			</form>
		</div>
