<?php /* Smarty version Smarty-3.0.7, created on 2014-10-16 09:50:53
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHqip3O" */ ?>
<?php /*%%SmartyHeaderCode:66394581543f94fd9de252-40017553%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b46b756b49dbf73d9237e5bf05249af5d88ae190' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeHqip3O',
      1 => 1413453053,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '66394581543f94fd9de252-40017553',
  'function' => 
  array (
  ),
...
"><h3 class="nowra"><?php echo $_smarty_tpl->getVariable('record')->value['TITLE'];?>
 <?php echo $_smarty_tpl->getVariable('record')->value['COMPANY'];?>
&nbsp;</h3></a>
...
">
                <?php if (($_smarty_tpl->getVariable('record')->value['IMG'])){?>
                    <?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->getVariable('record')->value['IMG'],'w'=>400,'h'=>300,'rmode'=>"cco",'ext'=>'jpg','class'=>"img-responsive"),$_smarty_tpl);?>
