<?php /* Smarty version Smarty-3.0.7, created on 2015-02-07 11:57:31
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/664.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:108737133654d5ef9b39eb94-63323579%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b6f563035c97fd187f281384df3e3910526cfb6' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/664.cache.html',
      1 => 1423213360,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '108737133654d5ef9b39eb94-63323579',
  'function' => 
  array (
  ),
...
?><?php echo smarty_function_xr_siteCall(array('fn'=>'fe_rankingnew::sc_getStartRanking','ar_contactType_id'=>2,'var'=>'data'),$_smarty_tpl);?>
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_my_profile::sc_get_backend_countries','var'=>'countries'),$_smarty_tpl);?>
	...
	<div class="row">
		...
		<div class="col-sm-3" style="margin-top: 55px;">
			<br>
			<form>
				<ul class="listCD padLeft ranking-menu newranking">
					<li class="IclientsND">
						<a href="#" class="ranking_filter" id="ranking_7" data-src="7">Client</a>
					</li>
					<li class="IagencyND">
						<a href="#" class="ranking_filter" id="ranking_2" data-src="2">Ad Agency<span class="rankingCounter"></span></a>
					</li>
					...
					<li class="IphotographerND">
						<a href="#" class="active ranking_filter" id="ranking_1" data-src="1">Photographer<span class="rankingCounter"></a>
					</li>
...
"<?php if ($_smarty_tpl->tpl_vars['v']->value['ac_id']==$_smarty_tpl->getVariable('data')->value['COUNTRY']){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['ac_name'];?>
		...
		<div id="ranking-section-result" class="col-sm-9">
    		<h2 id="ranking-section-title newranking" style="margin-bottom: 20px;">Photographer </h2>
