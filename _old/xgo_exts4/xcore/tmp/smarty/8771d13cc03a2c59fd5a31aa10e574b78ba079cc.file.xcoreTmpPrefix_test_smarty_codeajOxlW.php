<?php /* Smarty version Smarty-3.0.7, created on 2014-07-25 09:29:50
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeajOxlW" */ ?>
<?php /*%%SmartyHeaderCode:186811064053d2076e83a456-25061753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8771d13cc03a2c59fd5a31aa10e574b78ba079cc' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeajOxlW',
      1 => 1406273390,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '186811064053d2076e83a456-25061753',
  'function' => 
  array (
  ),
        ...
        <div class="row">
    		<div class="col-sm-12">
    			...
    			<ul class="nav nav-pills p-woche">
    				...
    				<?php if ((strpos($_smarty_tpl->getVariable('am')->value['commercials'],'col-sm-4'))){?><li class="mytabs"><a data-toggle="tab" id="film_tab" class="magazinetabslinks" href="#tab-commercials">Film</a></li><?php }?>
    				<?php if ((strpos($_smarty_tpl->getVariable('am')->value['digital'],'col-sm-4'))){?><li class="mytabs"><a data-toggle="tab" id="digital_tab" class="magazinetabslinks" href="#tab-digital">Digital</a></li><?php }?>
...
" data-type="MEDIA" href="#">Gefällt mir</a><span class="likeCount"><?php echo $_smarty_tpl->tpl_vars['v']->value['LIKES'];?>
    ...
    $(document).ready(function(){
        <?php if ($_smarty_tpl->getVariable('REQUEST')->value['tab']=='film'){?>
        $('#film_tab').trigger('click');
        <?php }?>
        
        <?php if ($_smarty_tpl->getVariable('REQUEST')->value['tab']=='digital'){?>
        $('#digital_tab').trigger('click');
        <?php }?>
    });
    <?php }?>