<?php /* Smarty version Smarty-3.0.7, created on 2014-08-04 12:56:44
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codelpWX2K" */ ?>
<?php /*%%SmartyHeaderCode:157207220253df66ec45afe1-70608914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '626f312746a95d5cd49bf00b05744ebec6bf4d74' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codelpWX2K',
      1 => 1407149804,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157207220253df66ec45afe1-70608914',
  'function' => 
  array (
  ),
...
/<?php echo $_smarty_tpl->getVariable('data')->value['MAGAZINEYEAR'];?>
    ...
    <div class="row">
		<div class="col-sm-8 videoplayer">
		    <?php echo smarty_function_xr_img(array('s_id'=>$_smarty_tpl->getVariable('data')->value['JSON']['es_video_poster_s_id'],'w'=>539,'h'=>303,'rmode'=>"cco",'q'=>85,'var'=>"poster"),$_smarty_tpl);?>

		    <?php echo smarty_function_xr_file(array('s_id'=>$_smarty_tpl->getVariable('data')->value['JSON']['es_video_480_mp4_s_id'],'var'=>'mp4'),$_smarty_tpl);?>

		    <?php echo smarty_function_xr_file(array('s_id'=>$_smarty_tpl->getVariable('data')->value['JSON']['es_video_1080_webm_s_id'],'var'=>'webm'),$_smarty_tpl);?>
...
'
 ...
 data-type="MEDIA">Add to favorites</a>
            <?php if ($_smarty_tpl->getVariable('data')->value['JSON']['es_video_1080_mp4_s_id']>0){?>
            <a class="but" href="<?php echo smarty_function_xr_download(array('s_id'=>$_smarty_tpl->getVariable('data')->value['JSON']['es_video_1080_mp4_s_id']),$_smarty_tpl);?>
">Download Video</a>
            <?php }?>
            </p></div>
