<?php /* Smarty version Smarty-3.0.7, created on 2014-10-20 10:28:34
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeuqN5lN" */ ?>
<?php /*%%SmartyHeaderCode:3806814855444e3d2c28c90-91339011%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ff1d5bb35fcab5f54231bf2d2960443400d8645' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeuqN5lN',
      1 => 1413800914,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3806814855444e3d2c28c90-91339011',
  'function' => 
  array (
  ),
...
" target="_blank"><strong><?php echo $_smarty_tpl->getVariable('data')->value['URL'];?>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<ul class="nav nav-pills p-woche">
				...
				<li<?php if (!(strpos($_smarty_tpl->getVariable('work')->value,'col-sm-4'))){?> class="active"<?php }?></li><a data-toggle="tab" href="#tab-beyond">Beyond in Archive</a></li>
				<?php }?>
			</ul>
		</div>
	</div>
	...
	<div class="tab-content">
		...
		<div id="tab-beyond" class="tab-pane<?php if ($_smarty_tpl->getVariable('work')->value==''){?> active<?php }?>">
