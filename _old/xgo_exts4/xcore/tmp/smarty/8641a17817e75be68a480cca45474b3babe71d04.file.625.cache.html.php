<?php /* Smarty version Smarty-3.0.7, created on 2014-08-05 21:25:28
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/625.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:37917858253e12fa849d2d8-56718337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8641a17817e75be68a480cca45474b3babe71d04' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/625.cache.html',
      1 => 1407266728,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '37917858253e12fa849d2d8-56718337',
  'function' => 
  array (
  ),
...
<?php echo smarty_function_xr_siteCall(array('fn'=>'oe_preview::sc_get_other','var'=>'data'),$_smarty_tpl);?>

<?php }else{ ?>
<?php echo smarty_function_xr_siteCall(array('fn'=>'fe_otherarticle::sc_detailpage_get_id','var'=>'data'),$_smarty_tpl);?>
...
<?php }?>
	...
	<div class="row">
	    <div class="col-sm-6">
			<h2><a href=""><?php echo $_smarty_tpl->getVariable('data')->value['TITLE'];?>
</a> <a class="more" href="">More</a></h2>
			<div class="row">
				<div class="col-md-7">
					<p><?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->getVariable('data')->value['IMG'],'rmode'=>'cco','w'=>250,'h'=>210,'class'=>"img-responsive"),$_smarty_tpl);?>
</p>
				</div>
				<div class="col-md-5">
				        <p><?php echo $_smarty_tpl->getVariable('data')->value['SHORTDESC'];?>
</p>
				</div>
			</div>
		</div>
...
?>
    		    ...
    		    <?php }?>
                <span>
    		    <a data-lightbox="image-<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" data-title="<h4><?php echo $_smarty_tpl->tpl_vars['v']->value['TITLE'];?>
