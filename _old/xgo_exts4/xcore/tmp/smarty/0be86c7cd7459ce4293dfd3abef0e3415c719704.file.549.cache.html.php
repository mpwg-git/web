<?php /* Smarty version Smarty-3.0.7, created on 2015-01-06 05:53:47
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/549.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:183001494854ab6a5b80ccb4-42719200%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0be86c7cd7459ce4293dfd3abef0e3415c719704' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/549.cache.html',
      1 => 1420468338,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '183001494854ab6a5b80ccb4-42719200',
  'function' => 
  array (
  ),
...
">
	<div class="col-sm-4 static-uploaded-images">
	    <?php if ($_smarty_tpl->tpl_vars['data']->value['estd_cover_thumbnail']!=''){?>
	    <img src="<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_cover_thumbnail'];?>
" id="coverImage_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
" class="img-responsive" alt="" />
	    <?php }else{ ?>
	    <?php echo smarty_function_xr_imgWrapper(array('s_id'=>270410,'w'=>349,'h'=>208,'rmode'=>"cco",'ext'=>'jpg','class'=>"img-responsive",'id'=>"coverImage_".($_smarty_tpl->tpl_vars['data']->value['estd_id'])),$_smarty_tpl);?>
...
" style="color: green;">PRESENT</span><?php }?>
			<form enctype="multipart/form-data" method="POST" action="/xsite/call/fe_submissions/upload_video_highres" id="fileupload_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">
			<input type="hidden" name="SUBMISSIONTYPE" value="VIDEO" />
			<span class="btn btn-default fileinput-button" id="uploadHighresVideo_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">
...
" style="display:none; color: #a94442; font-weight: bold;">File is too large</span>
		...
		<br />
        <div class="image-info-plus upload-area">
			<form enctype="multipart/form-data" method="POST" action="/xsite/call/fe_submissions/upload_video_cover" id="Coverimage_fileupload_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">
			<input type="hidden" name="SUBMISSIONTYPE" value="VIDEO" />
			<span class="btn btn-default fileinput-button" id="uploadCoverimage_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">
				<i class="glyphicon glyphicon-plus"> </i>
				<span>Add Still...</span>
				<input type="file" name="files">
...
" />
            ...
            <div class="progress_container" id="Coverimage_upload_progress_container-<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
" style="margin-top: 10px;">
				<div class="progress_bar" id="Coverimage_upload_progress_bar-<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">
			  		 <div class="progress_completed" id="Coverimage_upload_progress_completed-<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
"></div>
				</div>
		    </div>
		    <span id="unsupported_file_still_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
" style="display:none; color: #a94442; font-weight: bold;">File type not allowed</span>
			<span id="toobig_file_still_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
" style="display:none; color: #a94442; font-weight: bold;">File is too large</span>
		</div>
		<br />
		<div class="image-info-plus upload-area">
            <a href="" class="but selectCoverImage" data-id="<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">Select Still from Video</a>
            <div class="thumb_loader" id="thumb_loader_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
"> </div>
            <div class="clearer"> </div>
            <div id="selectCoverImageWrapper_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
...
" class="form-control exampleCampaign highlight-on-error validate[required]" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['RAWDATA']['Campaign'];?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
" />
		</div>
...
" class="form-control exampleCampaign highlight-on-error validate[required]" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['RAWDATA']['ADTitle'];?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
" />
		</div>
		...
		<div class="form-group">
					...
					<textarea class="form-control exampleExplanation height200" name="Explanation" id="Explanation_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['data']->value['RAWDATA']['Explanation'];?>
		...
		<div class="form-group">
					...
					<input type="text" class="form-control datepicker exampleRelease highlight-on-error validate[required]" name="Release" id="Release_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
...
" />
		...
		<div class="form-group">
				...
				<input type="text" class="form-control exampleKeywords" name="Keywords" id="Keywords_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
