<?php /* Smarty version Smarty-3.0.7, created on 2014-07-25 09:30:50
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codetHxaCy" */ ?>
<?php /*%%SmartyHeaderCode:184140128353d207aaca7a33-67058442%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1089ebe422104a36fe0ee26f91043960d5598a2b' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codetHxaCy',
      1 => 1406273450,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '184140128353d207aaca7a33-67058442',
  'function' => 
  array (
  ),
        ...
        <div class="row">
    		<div class="col-sm-12">
    			...
    			<ul class="nav nav-pills p-woche">
    				...
    				<?php if ((strpos($_smarty_tpl->getVariable('am')->value['digital'],'col-sm-4'))){?><li id="digital_tab" class="mytabs"><a data-toggle="tab" class="magazinetabslinks" href="#tab-digital">Digital</a></li><?php }?>
