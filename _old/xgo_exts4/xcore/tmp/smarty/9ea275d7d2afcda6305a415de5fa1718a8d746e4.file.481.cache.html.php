<?php /* Smarty version Smarty-3.0.7, created on 2014-10-30 18:20:51
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/481.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:323193730545281835f7215-82472384%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ea275d7d2afcda6305a415de5fa1718a8d746e4' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/481.cache.html',
      1 => 1414692985,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '323193730545281835f7215-82472384',
  'function' => 
  array (
  ),
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="checkbox" value=""<?php if ($_smarty_tpl->getVariable('data')->value['publish_FIRSTNAME']==1){?> checked="checked" <?php }?> <?php if ($_smarty_tpl->getVariable('data')->value['TYPE']==1){?>disabled<?php }?> id="fep_publishFirstname" class="publish-in-profile" data-toggle="tooltip" title="Publish in Profile">
...
" id="inputFNAME" class="form-control required" name="fep_firstname">
					...
					<div class="col-sm-6">  
						<div class="form-group">
							...
							<input type="checkbox" value=""<?php if ($_smarty_tpl->getVariable('data')->value['publish_LASTNAME']==1){?> checked="checked" <?php }?> <?php if ($_smarty_tpl->getVariable('data')->value['TYPE']==1){?>disabled<?php }?> id="fep_publishLastname" class="publish-in-profile" data-toggle="tooltip" title="Publish in Profile">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="checkbox" value=""<?php if ($_smarty_tpl->getVariable('data')->value['publish_COMPANY']==1||$_smarty_tpl->getVariable('data')->value['TYPE']==0){?> checked="checked" <?php }?><?php if ($_smarty_tpl->getVariable('data')->value['TYPE']==0){?>disabled<?php }?> id="fep_publishCompany" class="publish-in-profile" data-toggle="tooltip" title="Publish in Profile">
