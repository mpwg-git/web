<?php /* Smarty version Smarty-3.0.7, created on 2014-12-15 10:38:04
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/644.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:893200742548eba0cd2c802-02228511%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de2dc4c59b927f821effbb62231ad9e671c1a597' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/644.cache.html',
      1 => 1417700317,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '893200742548eba0cd2c802-02228511',
  'function' => 
  array (
  ),
...
?><?php echo smarty_function_xr_siteCall(array('fn'=>'be_voting::get_voting_detail_step2','var'=>'data'),$_smarty_tpl);?>


<div class="row" style="margin-bottom: 20px">
	<div class="col-sm-6 voting-button">
		<a href="#" class="btn reject-button full-width-button" id="reject-button-step2" data-id="<?php echo $_smarty_tpl->getVariable('data')->value['submission']['es_id'];?>
" data-ev="<?php echo $_smarty_tpl->getVariable('data')->value['ev_id'];?>
">No</a>
	</div>
	
	<div class="col-sm-6 voting-button">
		<a href="#" class="btn accept-button full-width-button" id="accept-button-step2" data-id="<?php echo $_smarty_tpl->getVariable('data')->value['submission']['es_id'];?>
" data-ev="<?php echo $_smarty_tpl->getVariable('data')->value['ev_id'];?>
">Yes</a>
	</div>
</div>
...
" type='video/mp4' />
        ...
        <?php }else{ ?>
        <?php echo smarty_function_xr_img(array('s_id'=>$_smarty_tpl->getVariable('data')->value['submission']['es_image_s_id'],'w'=>1600,'var'=>'image'),$_smarty_tpl);?>

        <a data-lightbox="gallery" data-title="" href="<?php echo $_smarty_tpl->getVariable('image')->value['src'];?>
">
