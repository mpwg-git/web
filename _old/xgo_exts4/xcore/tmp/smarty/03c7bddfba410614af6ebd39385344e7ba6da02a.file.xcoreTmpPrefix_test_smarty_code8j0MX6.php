<?php /* Smarty version Smarty-3.0.7, created on 2014-09-25 01:27:24
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code8j0MX6" */ ?>
<?php /*%%SmartyHeaderCode:212835543954236f7c26ba77-71350541%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '03c7bddfba410614af6ebd39385344e7ba6da02a' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_code8j0MX6',
      1 => 1411608444,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '212835543954236f7c26ba77-71350541',
  'function' => 
  array (
  ),
...
"<?php if ((count($_smarty_tpl->getVariable('dropdowns')->value['weeks'])-$_smarty_tpl->tpl_vars['k']->value)==$_smarty_tpl->getVariable('dropdowns')->value['feature_week']){?> selected="selected"<?php }?>>Week <?php echo count($_smarty_tpl->getVariable('dropdowns')->value['weeks'])-$_smarty_tpl->tpl_vars['k']->value;?>
        ...
        $( document ).ready(function() {
            ...
            $('.features-slider-tabs2').click(function(){
                ...
                fe_core.loadFragment({

    				loading_el_animation: $('#fe_core_loader'),

    				loading_el: $('h1'),
    				loading_txt: "Loading Features ... ",
    
    				div: 'FULL_REPLACE_FEATURES_TYPE',
    				url: url,
