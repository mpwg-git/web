<?php /* Smarty version Smarty-3.0.7, created on 2015-01-13 14:52:48
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeXYDs54" */ ?>
<?php /*%%SmartyHeaderCode:184361317054b5233076c1e8-43120034%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01d8d4e903a098dfd0ddf04edf0a5a0b92afb2de' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xcore/tmp/xcoreTmpPrefix_test_smarty_codeXYDs54',
      1 => 1421157168,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '184361317054b5233076c1e8-43120034',
  'function' => 
  array (
  ),
...
">
                                ...
                                <?php if (($_smarty_tpl->tpl_vars['v']->value['fep_type']==0&&$_smarty_tpl->tpl_vars['v']->value['fep_company']!='')){?>
...
?>
 ...
 <?php }?><?php echo $_smarty_tpl->tpl_vars['v']->value['fep_lastname'];?>
        		...
        		<p class="r-pos">CURRENTLY RANKED: 
        		<strong>
                <?php if ($_smarty_tpl->tpl_vars['v']->value['RANK']){?>
        	    <?php echo $_smarty_tpl->tpl_vars['v']->value['RANK'];?>
...
<?php }else{ ?>100<?php }?>%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar">
        	...
        	<div class="col-sm-3 rankingnew-logospalte">
        		<p><a href="<?php echo $_smarty_tpl->tpl_vars['v']->value['LINK'];?>
">
        		<?php if ($_smarty_tpl->tpl_vars['v']->value['fep_profile_image_s_id']==0){?>
        		    <?php echo smarty_function_xr_imgWrapper(array('s_id'=>858272,'w'=>700,'h'=>700,'rmode'=>'cco','class'=>"img-responsive"),$_smarty_tpl);?>

        		<?php }else{ ?>
        		    <?php echo smarty_function_xr_imgWrapper(array('s_id'=>$_smarty_tpl->tpl_vars['v']->value['fep_profile_image_s_id'],'w'=>400,'h'=>400,'cloud'=>0,'rmode'=>'festrict','class'=>"img-responsive leichterrahmen"),$_smarty_tpl);?>
