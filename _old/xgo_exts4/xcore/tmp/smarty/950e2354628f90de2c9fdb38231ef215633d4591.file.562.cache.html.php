<?php /* Smarty version Smarty-3.0.7, created on 2015-01-05 22:11:04
         compiled from "/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/562.cache.html" */ ?>
<?php /*%%SmartyHeaderCode:127553460854aafde84ad7e8-31927885%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '950e2354628f90de2c9fdb38231ef215633d4591' => 
    array (
      0 => '/srv/www/www.luerzersarchive.net/web/xgo/xplugs/xredaktor/classes/../smarty/atom_cache/562.cache.html',
      1 => 1420468376,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '127553460854aafde84ad7e8-31927885',
  'function' => 
  array (
  ),
...
" style="color: green;">PRESENT</span><?php }?>
			<form enctype="multipart/form-data" method="POST" action="/xsite/call/fe_submissions/upload_students_highres" id="fileupload_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">
...
">x</button> 
            ...
            <div class="row">
				<div class="col-sm-12 marginTop20 marginBottom20">
        			...
        			<a href="" class="but button-large next-in-students-submission" id="next-in-submission_<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['data']->value['estd_id'];?>
">confirm</a>
                    </div>
                </div>
