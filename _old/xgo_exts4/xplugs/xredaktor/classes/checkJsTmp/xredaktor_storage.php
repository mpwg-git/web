...
class xredaktor_storage
{
	...
	public static function delFiles($ids)
	{
		$ids = explode(",",$ids);
		$safeIds = array();
	...
	public static function xr_img2($params)
	{
		...
		$onDisk 	= imagesx::smartResizer($fileOnDisk,$w,$h,$rmode,$cacheDir,false,true,false,$type,$file_name.'_'.$s_id,$q,$colorspace,$crop);
