...
xredaktor_manage_sites_.prototype = {
	...
	getMainPanel : function()
	{
		...
		{fs: 'A',	name: 's_p_id',						text:xframe.lang('Startpage')			, type: 'int'},
		{fs: 'A',	name: 's_error_p_id',				text:xframe.lang('Errorpage')			, type: 'int'},
		{fs: 'A',  	name: 's_p_id_outofdate',			text:xframe.lang('Out-Of-Date')			, type: 'int'},

		{fs: 'A',  	name: 's_p_id_mobile',				text:xframe.lang('Mobile-Startseite')	, type: 'int'},
		...
		this.sitesWrapper = Ext.create('Ext.tab.Panel', {
			...
			region:'center',
			disabled:true,
			items: [this.basicConfig,this.domains,this.languages_fe,this.languages_face,this.robots,this.humans,this.feUsersPanelWrapper,this.getCSSPanel()]
		});
		...
		this.sites.on('selectionchange',function(v,sel){
			...
			xframe.guiSetParams({s_id:s_id},[this.domains,this.languages_fe,this.languages_be,this.languages_face],true);
