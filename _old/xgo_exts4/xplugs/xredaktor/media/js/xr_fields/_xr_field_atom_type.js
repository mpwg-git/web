		...
		var data = {
			...
			/*{
				...
				children:[
				{
					label: 		'Kommentar',
					as_type: 	"COMMENT",
					iconCls:	'xr_field_comment',
					expanded: 	true,
					btn_cfg: true
				},{
					label: 		'Trennlinie - Horizontal',
					as_type: 	"SPLITTER_H",
					iconCls:	'xr_field_split_h',
					expanded: 	true,
				},{
					label: 		'Trennlinie - Vertikal',
					as_type: 	"SPLITTER_V",
					iconCls:	'xr_field_split_v',
					expanded: 	true,
				}]
			}
			...
			,*/{
				...
				},
				{
					...
					guiMode: {'0':'Checkboxen','1':'Search-Combobox (1:n)','2':'Search-Grid (n:n)'},
					btn_cfg: true
				},
				/*{
