...
xluerzer_contacts_.prototype = {
	...
	searchContacts: function() {
		...
		xluerzer_gui.getInstance().searchComboCrm({
	...
	show: function(id) {
		...
		var ranking = xframe_pattern.getInstance().genGrid({
			...
			pager: true,
			xstore: {
				load: 	this.getAjaxPath('s_e_contact_details/load/'+id),
				pid: 	'ec_id',
				fields: [
		...
		var representant = xframe_pattern.getInstance().genGrid({
			...
			pager: true,
			xstore: {
				load: 	this.getAjaxPath('s_e_contact_representants/load/'+id),
				remove: this.getAjaxPath('s_e_contact_representants/remove'),
				update: this.getAjaxPath('s_e_contact_representants_details/update'),
				insert: this.getAjaxPath('s_e_contact_representants/insert'),
				move: 	this.getAjaxPath('s_e_contact_representants/move'),
		...
		var duplicates = xframe_pattern.getInstance().genGrid({
			...
			pager: true,
			xstore: {
				load: 	this.getAjaxPath('s_e_contact_duplicates/load/'+id),
				pid: 	'ecd_id',
				fields: [
		...
		var associates = xframe_pattern.getInstance().genGrid({
			...
			pager: true,
			xstore: {
				load: 	this.getAjaxPath('s_e_contact_associates/load/'+id),
				pid: 	'eca_id',
				fields: [
		...
		var paidads = xframe_pattern.getInstance().genGrid({
			...
			pager: true,
			xstore: {
				load: 	this.getAjaxPath('s_e_contact_paidads/load/'+id),
				pid: 	'id_x',
				fields: [
		...
		var log = xframe_pattern.getInstance().genGrid({
			...
			pager: true,
			xstore: {
				load: 	this.getAjaxPath('s_e_contact_log/load/'+id),
				pid: 	'id_x',
				fields: [
				{name:'ecb_id', 		text:'ID', 					type: 'int'},
				{name:'ecb_firstname',	text:'Firstname',			type: 'string'},
		...
		var backups = xframe_pattern.getInstance().genGrid({
			...
			pager: true,
			xstore: {
				load: 	this.getAjaxPath('s_e_contact_backups/load/'+id),
				pid: 	'id_x',
				fields: [
				{name:'ecb_id', 		text:'ID', 					type: 'int'},
				{name:'ecb_firstname',	text:'Firstname',			type: 'string'},
		...
		loadData = function()
		{
			...
			xframe.ajax({
				scope: me,
				url: me.getAjaxPath('s_contact_details/load'),
				params : {
					ec_id: id
				},
		...
		saveData = function(values)
		{
			...
			xframe.ajax({
				...
				type: 'post',
				jsonData: values,
				url: me.getAjaxPath('s_contact_details/save'),
				params : {
					ec_id: id
				},
				stateless: function(success, json)
