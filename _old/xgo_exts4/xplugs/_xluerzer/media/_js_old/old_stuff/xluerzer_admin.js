	...
	getMenu: function() {
		...
		xluerzer_gui.getInstance().defaultAction({
			...
			cfg_grid: {
				...
				pid: 'afc_id',
				fields: [{name:'afc_lastname',text:'Last Name'},{name:'afc_firstname',text:'First name'},{name:'afc_company',text:'Company'},{name:'afc_zipcode',text:'ZIP'},{name:'afc_city',text:'City'},{name:'afc_country_id',text:'Country'},{name:'afc_modified_ts',text:'Modified'},{name:'afc_profileViews',text:'Profile Views'}],
				scopex: 'a_frontendcontact',
				initSort: '[{"property":"afc_lastname,"direction":"ASC"}]'
			},
