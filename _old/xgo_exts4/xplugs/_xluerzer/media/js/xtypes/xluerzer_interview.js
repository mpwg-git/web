Ext.define('Ext.xr.xluerzer_interview', {
	extend: 'Ext.form.FieldContainer',
	alias: 'widget.xluerzer_interview',
	...
	open: function()
	{
		...
		xluerzer_e.getInstance().open_interview(ei_id);
	},

	search: function()
	{
		xluerzer_e.getInstance().search4interviewPopUp({
			scope: this,
