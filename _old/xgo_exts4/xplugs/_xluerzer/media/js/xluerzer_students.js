...
xluerzer_students_.prototype = {
	...
	openGrid_day: function(dayx)
	{
		...
		{name:'ess_credits_donotknow_total',			text:"Credits (Calculated)", 		type: 'string'},
		...
		var submissions = xframe_pattern.getInstance().genGrid({
			...
			toolbar_top: [{
				...
				menu: [{
					...
					handler: function()
					{
						this.bulkChangeSubmission(submissions,'ess_state',true);
					}
				},{
					...
					handler: function()
					{
						this.bulkChangeSubmission(submissions,'ess_magazine_id',true);
					}
				}]
			},{
				iconCls: 'xf_bulk',
	...
	*/
	...
	open_search: function(returnGui)
	{
		...
		*/
		...
		{name:'ess_credits_none_total',				text:'Credits None', 			type: 'string'},
		*/
		{name:'ess_credits_donotknow_total',			text:"Credits Don't know", 		type: 'string',  renderer: this.renderer_donknow},

		{name:'ess_image_highRes_status',	text:'HighRes', 		type: 'string'},
		
		{name:'ess_created_ts',	text:'Submitted on', 		type: 'string'}
		...
		this.contactsGrid = xframe_pattern.getInstance().genGrid({
			...
			toolbar_top: [
			{
				...
				menu: [{
					...
					handler: function()
					{
						this.bulkChangeSubmission(this.contactsGrid,'ess_state',true);
					}
				},{
					text: 'Change Magazine',
					scope: this,
					handler: function()
					{
						this.bulkChangeSubmission(this.contactsGrid,'ess_magazine_id',true);
					}
				}]
			},{
				iconCls: 'xf_bulk',
				...
				menu: [
				{
					...
					handler: function()
					{
						this.zipAndDownload(this.contactsGrid,'sub_thumbs_students');
					}
				},{
					text: '<b>All</b> Print',
					scope: this,
					handler: function()
					{
						this.zipAndDownload(this.contactsGrid,'sub_print_students');
					}
				},/*{
					text: '<b>All</b> Videos',
					scope: this,
					...
					handler: function()
					{
						this.zipAndDownload(this.contactsGrid,'sel_sub_thumbs_students');
					}
				},{
					text: 'Selected Print',
					scope: this,
					handler: function()
					{
						this.zipAndDownload(this.contactsGrid,'sel_sub_print_students');
					}
				}/*,{
	...
	zipAndDownload: function(grid,downloadFilesScope)
	{
		...
		console.log("zip url final", url, downloadFilesScope);

		window.open(url,'DOWNLOAD2');
	},
