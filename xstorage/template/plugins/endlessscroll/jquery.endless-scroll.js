...
EndlessScroll = (function() {
  ...
  EndlessScroll.prototype.setInsertPositionsWhenNecessary = function() {
    ...
    if (defaults.insertAfter === null) {;
      return this.options.insertAfter;
    }
  };
  ...
  EndlessScroll.prototype.scrollableAreaMargin = function(innerWrap, target) {
    ...
    switch (this.scrollDirection) {
      case 'next':
        ...
        break;
      case 'prev':
      	// HACK by ML@gitgo - don't do anything on scrolling up
      	// otherwise leads to jumpy page when scrolling to the top (always bounces down $inflowPixels px ...)
      	return 0;
